...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
       ...
       4:	aa878793          	addi	a5,a5,-1368 # 6aa8 <uninit>
       8:	00009697          	auipc	a3,0x9
       c:	1b068693          	addi	a3,a3,432 # 91b8 <buf>
    if(uninit[i] != '\0'){
      ...
      1c:	8082                	ret
{
      ...
      2c:	b4050513          	addi	a0,a0,-1216 # 4b68 <malloc+0x372>
      30:	00004097          	auipc	ra,0x4
      34:	708080e7          	jalr	1800(ra) # 4738 <printf>
      exit(1);
      38:	4505                	li	a0,1
...
0000000000000042 <iputtest>:
{
  ...
  if(chdir("/") < 0){
    ...
    printf("%s: mkdir failed\n", s);
      ...
      ae:	ade50513          	addi	a0,a0,-1314 # 4b88 <malloc+0x392>
      b2:	00004097          	auipc	ra,0x4
      b6:	686080e7          	jalr	1670(ra) # 4738 <printf>
    exit(1);
      ba:	4505                	li	a0,1
    ...
    printf("%s: chdir iputdir failed\n", s);
      ...
      ca:	ada50513          	addi	a0,a0,-1318 # 4ba0 <malloc+0x3aa>
      ce:	00004097          	auipc	ra,0x4
      d2:	66a080e7          	jalr	1642(ra) # 4738 <printf>
    exit(1);
      d6:	4505                	li	a0,1
    ...
    printf("%s: unlink ../iputdir failed\n", s);
      ...
      e6:	aee50513          	addi	a0,a0,-1298 # 4bd0 <malloc+0x3da>
      ea:	00004097          	auipc	ra,0x4
      ee:	64e080e7          	jalr	1614(ra) # 4738 <printf>
    exit(1);
      f2:	4505                	li	a0,1
    ...
    printf("%s: chdir / failed\n", s);
     ...
     102:	afa50513          	addi	a0,a0,-1286 # 4bf8 <malloc+0x402>
     106:	00004097          	auipc	ra,0x4
     10a:	632080e7          	jalr	1586(ra) # 4738 <printf>
    exit(1);
     10e:	4505                	li	a0,1
...
0000000000000118 <rmdot>:
{
  ...
  if(unlink("dots") != 0){
    ...
    printf("%s: mkdir dots failed\n", s);
     ...
     1c4:	a5850513          	addi	a0,a0,-1448 # 4c18 <malloc+0x422>
     1c8:	00004097          	auipc	ra,0x4
     1cc:	570080e7          	jalr	1392(ra) # 4738 <printf>
    exit(1);
     1d0:	4505                	li	a0,1
    ...
    printf("%s: chdir dots failed\n", s);
     ...
     1e0:	a5450513          	addi	a0,a0,-1452 # 4c30 <malloc+0x43a>
     1e4:	00004097          	auipc	ra,0x4
     1e8:	554080e7          	jalr	1364(ra) # 4738 <printf>
    exit(1);
     1ec:	4505                	li	a0,1
    ...
    printf("%s: rm . worked!\n", s);
     ...
     1fc:	a5850513          	addi	a0,a0,-1448 # 4c50 <malloc+0x45a>
     200:	00004097          	auipc	ra,0x4
     204:	538080e7          	jalr	1336(ra) # 4738 <printf>
    exit(1);
     208:	4505                	li	a0,1
    ...
    printf("%s: rm .. worked!\n", s);
     ...
     218:	a5c50513          	addi	a0,a0,-1444 # 4c70 <malloc+0x47a>
     21c:	00004097          	auipc	ra,0x4
     220:	51c080e7          	jalr	1308(ra) # 4738 <printf>
    exit(1);
     224:	4505                	li	a0,1
    ...
    printf("%s: chdir / failed\n", s);
     ...
     234:	9c850513          	addi	a0,a0,-1592 # 4bf8 <malloc+0x402>
     238:	00004097          	auipc	ra,0x4
     23c:	500080e7          	jalr	1280(ra) # 4738 <printf>
    exit(1);
     240:	4505                	li	a0,1
    ...
    printf("%s: unlink dots/. worked!\n", s);
     ...
     250:	a4450513          	addi	a0,a0,-1468 # 4c90 <malloc+0x49a>
     254:	00004097          	auipc	ra,0x4
     258:	4e4080e7          	jalr	1252(ra) # 4738 <printf>
    exit(1);
     25c:	4505                	li	a0,1
    ...
    printf("%s: unlink dots/.. worked!\n", s);
     ...
     26c:	a5050513          	addi	a0,a0,-1456 # 4cb8 <malloc+0x4c2>
     270:	00004097          	auipc	ra,0x4
     274:	4c8080e7          	jalr	1224(ra) # 4738 <printf>
    exit(1);
     278:	4505                	li	a0,1
    ...
    printf("%s: unlink dots failed!\n", s);
     ...
     288:	a5450513          	addi	a0,a0,-1452 # 4cd8 <malloc+0x4e2>
     28c:	00004097          	auipc	ra,0x4
     290:	4ac080e7          	jalr	1196(ra) # 4738 <printf>
    exit(1);
     294:	4505                	li	a0,1
...
000000000000029e <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     2bc:	8c850513          	addi	a0,a0,-1848 # 4b80 <malloc+0x38a>
    ...
    if(chdir("iputdir") < 0){
     ...
     2d0:	8b450513          	addi	a0,a0,-1868 # 4b80 <malloc+0x38a>
    ...
    if(unlink("../iputdir") < 0){
     ...
     2e4:	8e050513          	addi	a0,a0,-1824 # 4bc0 <malloc+0x3ca>
    ...
    printf("%s: fork failed\n", s);
     ...
     304:	9f850513          	addi	a0,a0,-1544 # 4cf8 <malloc+0x502>
     308:	00004097          	auipc	ra,0x4
     30c:	430080e7          	jalr	1072(ra) # 4738 <printf>
    exit(1);
     310:	4505                	li	a0,1
     ...
     320:	86c50513          	addi	a0,a0,-1940 # 4b88 <malloc+0x392>
     324:	00004097          	auipc	ra,0x4
     328:	414080e7          	jalr	1044(ra) # 4738 <printf>
      exit(1);
     32c:	4505                	li	a0,1
     ...
     33c:	9d850513          	addi	a0,a0,-1576 # 4d10 <malloc+0x51a>
     340:	00004097          	auipc	ra,0x4
     344:	3f8080e7          	jalr	1016(ra) # 4738 <printf>
      exit(1);
     348:	4505                	li	a0,1
     ...
     358:	87c50513          	addi	a0,a0,-1924 # 4bd0 <malloc+0x3da>
     35c:	00004097          	auipc	ra,0x4
     360:	3dc080e7          	jalr	988(ra) # 4738 <printf>
      exit(1);
     364:	4505                	li	a0,1
...
0000000000000386 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
     ...
     3e2:	91a50513          	addi	a0,a0,-1766 # 4cf8 <malloc+0x502>
     3e6:	00004097          	auipc	ra,0x4
     3ea:	352080e7          	jalr	850(ra) # 4738 <printf>
      exit(1);
     3ee:	4505                	li	a0,1
     ...
     3fe:	92e50513          	addi	a0,a0,-1746 # 4d28 <malloc+0x532>
     402:	00004097          	auipc	ra,0x4
     406:	336080e7          	jalr	822(ra) # 4738 <printf>
        exit(1);
     40a:	4505                	li	a0,1
     ...
     41a:	92a50513          	addi	a0,a0,-1750 # 4d40 <malloc+0x54a>
     41e:	00004097          	auipc	ra,0x4
     422:	31a080e7          	jalr	794(ra) # 4738 <printf>
        exit(1);
     426:	4505                	li	a0,1
...
000000000000043a <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
     ...
     492:	86a50513          	addi	a0,a0,-1942 # 4cf8 <malloc+0x502>
     496:	00004097          	auipc	ra,0x4
     49a:	2a2080e7          	jalr	674(ra) # 4738 <printf>
      exit(1);
     49e:	4505                	li	a0,1
     ...
     4b6:	84650513          	addi	a0,a0,-1978 # 4cf8 <malloc+0x502>
     4ba:	00004097          	auipc	ra,0x4
     4be:	27e080e7          	jalr	638(ra) # 4738 <printf>
        exit(1);
     4c2:	4505                	li	a0,1
...
00000000000004d4 <forkfork>:
{
    ...
    if(xstatus != 0) {
     ...
     530:	83450513          	addi	a0,a0,-1996 # 4d60 <malloc+0x56a>
     534:	00004097          	auipc	ra,0x4
     538:	204080e7          	jalr	516(ra) # 4738 <printf>
      exit(1);
     53c:	4505                	li	a0,1
     ...
     542:	e6a080e7          	jalr	-406(ra) # 43a8 <exit>
{
     ...
     588:	7ec50513          	addi	a0,a0,2028 # 4d70 <malloc+0x57a>
     58c:	00004097          	auipc	ra,0x4
     590:	1ac080e7          	jalr	428(ra) # 4738 <printf>
      exit(1);
     594:	4505                	li	a0,1
...
000000000000059e <reparent2>:
{
  ...
  exit(0);
     ...
     5d6:	02650513          	addi	a0,a0,38 # 55f8 <malloc+0xe02>
     5da:	00004097          	auipc	ra,0x4
     5de:	15e080e7          	jalr	350(ra) # 4738 <printf>
      exit(1);
     5e2:	4505                	li	a0,1
...
0000000000000606 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    printf("%s: fork claimed to work 1000 times!\n", s);
     ...
     636:	77650513          	addi	a0,a0,1910 # 4da8 <malloc+0x5b2>
     63a:	00004097          	auipc	ra,0x4
     63e:	0fe080e7          	jalr	254(ra) # 4738 <printf>
    exit(1);
     642:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    printf("%s: no fork at all!\n", s);
     ...
     698:	6fc50513          	addi	a0,a0,1788 # 4d90 <malloc+0x59a>
     69c:	00004097          	auipc	ra,0x4
     6a0:	09c080e7          	jalr	156(ra) # 4738 <printf>
    exit(1);
     6a4:	4505                	li	a0,1
     ...
     6b4:	72050513          	addi	a0,a0,1824 # 4dd0 <malloc+0x5da>
     6b8:	00004097          	auipc	ra,0x4
     6bc:	080080e7          	jalr	128(ra) # 4738 <printf>
      exit(1);
     6c0:	4505                	li	a0,1
    ...
    printf("%s: wait got too many\n", s);
     ...
     6d0:	71c50513          	addi	a0,a0,1820 # 4de8 <malloc+0x5f2>
     6d4:	00004097          	auipc	ra,0x4
     6d8:	064080e7          	jalr	100(ra) # 4738 <printf>
    exit(1);
     6dc:	4505                	li	a0,1
...
00000000000006e6 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
     700:	69b1                	lui	s3,0xc
     702:	35098993          	addi	s3,s3,848 # c350 <__BSS_END__+0x188>
     706:	1003d937          	lui	s2,0x1003d
     70a:	090e                	slli	s2,s2,0x3
     70c:	48090913          	addi	s2,s2,1152 # 1003d480 <__BSS_END__+0x100312b8>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
     ...
     750:	5ac50513          	addi	a0,a0,1452 # 4cf8 <malloc+0x502>
     754:	00004097          	auipc	ra,0x4
     758:	fe4080e7          	jalr	-28(ra) # 4738 <printf>
      exit(1);
     75c:	4505                	li	a0,1
     ...
     770:	69450513          	addi	a0,a0,1684 # 4e00 <malloc+0x60a>
     774:	00004097          	auipc	ra,0x4
     778:	fc4080e7          	jalr	-60(ra) # 4738 <printf>
      exit(1);
     77c:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    printf("%s: stacktest: read below stack %p\n", *sp);
     ...
     7ce:	0007c583          	lbu	a1,0(a5) # fffffffffffff000 <__BSS_END__+0xffffffffffff2e38>
     7d2:	00004517          	auipc	a0,0x4
     7d6:	64e50513          	addi	a0,a0,1614 # 4e20 <malloc+0x62a>
     7da:	00004097          	auipc	ra,0x4
     7de:	f5e080e7          	jalr	-162(ra) # 4738 <printf>
    exit(1);
     7e2:	4505                	li	a0,1
    ...
    printf("%s: fork failed\n", s);
     ...
     7f2:	50a50513          	addi	a0,a0,1290 # 4cf8 <malloc+0x502>
     7f6:	00004097          	auipc	ra,0x4
     7fa:	f42080e7          	jalr	-190(ra) # 4738 <printf>
    exit(1);
     7fe:	4505                	li	a0,1
...
0000000000000812 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
     ...
     822:	62a50513          	addi	a0,a0,1578 # 4e48 <malloc+0x652>
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     846:	60650513          	addi	a0,a0,1542 # 4e48 <malloc+0x652>
    ...
    if(fd >= 0){
     ...
     85c:	61050513          	addi	a0,a0,1552 # 4e68 <malloc+0x672>
     860:	00004097          	auipc	ra,0x4
     864:	ed8080e7          	jalr	-296(ra) # 4738 <printf>
      exit(1);
     868:	4505                	li	a0,1
    ...
    printf("%s: mkdir oidir failed\n", s);
     ...
     878:	5dc50513          	addi	a0,a0,1500 # 4e50 <malloc+0x65a>
     87c:	00004097          	auipc	ra,0x4
     880:	ebc080e7          	jalr	-324(ra) # 4738 <printf>
    exit(1);
     884:	4505                	li	a0,1
    ...
    printf("%s: fork failed\n", s);
     ...
     894:	46850513          	addi	a0,a0,1128 # 4cf8 <malloc+0x502>
     898:	00004097          	auipc	ra,0x4
     89c:	ea0080e7          	jalr	-352(ra) # 4738 <printf>
    exit(1);
     8a0:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
     ...
     8c2:	58a50513          	addi	a0,a0,1418 # 4e48 <malloc+0x652>
    ...
    printf("%s: unlink failed\n", s);
     ...
     8d6:	5be50513          	addi	a0,a0,1470 # 4e90 <malloc+0x69a>
     8da:	00004097          	auipc	ra,0x4
     8de:	e5e080e7          	jalr	-418(ra) # 4738 <printf>
    exit(1);
     8e2:	4505                	li	a0,1
...
0000000000000904 <opentest>:
{
  ...
  fd = open("echo", 0);
     ...
     916:	59650513          	addi	a0,a0,1430 # 4ea8 <malloc+0x6b2>
  ...
  fd = open("doesnotexist", 0);
     ...
     934:	59850513          	addi	a0,a0,1432 # 4ec8 <malloc+0x6d2>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
     ...
     954:	56050513          	addi	a0,a0,1376 # 4eb0 <malloc+0x6ba>
     958:	00004097          	auipc	ra,0x4
     95c:	de0080e7          	jalr	-544(ra) # 4738 <printf>
    exit(1);
     960:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     970:	56c50513          	addi	a0,a0,1388 # 4ed8 <malloc+0x6e2>
     974:	00004097          	auipc	ra,0x4
     978:	dc4080e7          	jalr	-572(ra) # 4738 <printf>
    exit(1);
     97c:	4505                	li	a0,1
...
0000000000000986 <createtest>:
{
  ...
  name[0] = 'a';
     ...
     998:	00478793          	addi	a5,a5,4 # 6998 <name>
  ...
  name[0] = 'a';
     ...
     9da:	fc278793          	addi	a5,a5,-62 # 6998 <name>
...
0000000000000a1a <forkforkfork>:
{
  ...
  unlink("stopforking");
     ...
     a2a:	4da50513          	addi	a0,a0,1242 # 4f00 <malloc+0x70a>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
     ...
     a56:	4ae50513          	addi	a0,a0,1198 # 4f00 <malloc+0x70a>
  ...
  sleep(10); // one second
    ...
    printf("%s: fork failed", s);
     ...
     a8e:	2d650513          	addi	a0,a0,726 # 4d60 <malloc+0x56a>
     a92:	00004097          	auipc	ra,0x4
     a96:	ca6080e7          	jalr	-858(ra) # 4738 <printf>
    exit(1);
     a9a:	4505                	li	a0,1
     ...
     aa8:	45c48493          	addi	s1,s1,1116 # 4f00 <malloc+0x70a>
     aac:	4581                	li	a1,0
     aae:	8526                	mv	a0,s1
...
0000000000000aea <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    for(pi = 0; pi < NCHILD; pi++){
     ...
     b58:	aa450513          	addi	a0,a0,-1372 # 55f8 <malloc+0xe02>
     b5c:	00004097          	auipc	ra,0x4
     b60:	bdc080e7          	jalr	-1060(ra) # 4738 <printf>
      exit(1);
     b64:	4505                	li	a0,1
     ...
     b84:	39050513          	addi	a0,a0,912 # 4f10 <malloc+0x71a>
     b88:	00004097          	auipc	ra,0x4
     b8c:	bb0080e7          	jalr	-1104(ra) # 4738 <printf>
          exit(1);
     b90:	4505                	li	a0,1
     ...
     bf6:	29e50513          	addi	a0,a0,670 # 4e90 <malloc+0x69a>
     bfa:	00004097          	auipc	ra,0x4
     bfe:	b3e080e7          	jalr	-1218(ra) # 4738 <printf>
            exit(1);
     c02:	4505                	li	a0,1
     ...
     c2a:	30250513          	addi	a0,a0,770 # 4f28 <malloc+0x732>
     c2e:	00004097          	auipc	ra,0x4
     c32:	b0a080e7          	jalr	-1270(ra) # 4738 <printf>
        exit(1);
     c36:	4505                	li	a0,1
    ...
    for(pi = 0; pi < NCHILD; pi++){
     ...
     c90:	2c450513          	addi	a0,a0,708 # 4f50 <malloc+0x75a>
     c94:	00004097          	auipc	ra,0x4
     c98:	aa4080e7          	jalr	-1372(ra) # 4738 <printf>
        exit(1);
     c9c:	4505                	li	a0,1
...
0000000000000d10 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
     ...
     d20:	42c50513          	addi	a0,a0,1068 # 5148 <malloc+0x952>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
     ...
     d32:	27250513          	addi	a0,a0,626 # 4fa0 <malloc+0x7aa>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
     ...
     d48:	2b450513          	addi	a0,a0,692 # 4ff8 <malloc+0x802>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
     ...
     d66:	30e50513          	addi	a0,a0,782 # 5070 <malloc+0x87a>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
     ...
     d82:	36250513          	addi	a0,a0,866 # 50e0 <malloc+0x8ea>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
     ...
     d94:	3a850513          	addi	a0,a0,936 # 5138 <malloc+0x942>
    ...
    printf("%s: mkdir 12345678901234 failed\n", s);
     ...
     db2:	1ca50513          	addi	a0,a0,458 # 4f78 <malloc+0x782>
     db6:	00004097          	auipc	ra,0x4
     dba:	982080e7          	jalr	-1662(ra) # 4738 <printf>
    exit(1);
     dbe:	4505                	li	a0,1
    ...
    printf("%s: mkdir 12345678901234/123456789012345 failed\n", s);
     ...
     dce:	1f650513          	addi	a0,a0,502 # 4fc0 <malloc+0x7ca>
     dd2:	00004097          	auipc	ra,0x4
     dd6:	966080e7          	jalr	-1690(ra) # 4738 <printf>
    exit(1);
     dda:	4505                	li	a0,1
    ...
    printf("%s: create 123456789012345/123456789012345/123456789012345 failed\n", s);
     ...
     dea:	24250513          	addi	a0,a0,578 # 5028 <malloc+0x832>
     dee:	00004097          	auipc	ra,0x4
     df2:	94a080e7          	jalr	-1718(ra) # 4738 <printf>
    exit(1);
     df6:	4505                	li	a0,1
    ...
    printf("%s: open 12345678901234/12345678901234/12345678901234 failed\n", s);
     ...
     e06:	29e50513          	addi	a0,a0,670 # 50a0 <malloc+0x8aa>
     e0a:	00004097          	auipc	ra,0x4
     e0e:	92e080e7          	jalr	-1746(ra) # 4738 <printf>
    exit(1);
     e12:	4505                	li	a0,1
    ...
    printf("%s: mkdir 12345678901234/12345678901234 succeeded!\n", s);
     ...
     e22:	2e250513          	addi	a0,a0,738 # 5100 <malloc+0x90a>
     e26:	00004097          	auipc	ra,0x4
     e2a:	912080e7          	jalr	-1774(ra) # 4738 <printf>
    exit(1);
     e2e:	4505                	li	a0,1
    ...
    printf("%s: mkdir 12345678901234/123456789012345 succeeded!\n", s);
     ...
     e3e:	31e50513          	addi	a0,a0,798 # 5158 <malloc+0x962>
     e42:	00004097          	auipc	ra,0x4
     e46:	8f6080e7          	jalr	-1802(ra) # 4738 <printf>
    exit(1);
     e4a:	4505                	li	a0,1
...
0000000000000e54 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     e70:	bac50513          	addi	a0,a0,-1108 # 4a18 <malloc+0x222>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     e84:	b98a8a93          	addi	s5,s5,-1128 # 4a18 <malloc+0x222>
      int cc = write(fd, buf, sz);
     e88:	00008a17          	auipc	s4,0x8
     e8c:	330a0a13          	addi	s4,s4,816 # 91b8 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     e90:	6b0d                	lui	s6,0x3
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     f06:	28e50513          	addi	a0,a0,654 # 5190 <malloc+0x99a>
     f0a:	00004097          	auipc	ra,0x4
     f0e:	82e080e7          	jalr	-2002(ra) # 4738 <printf>
      exit(1);
     f12:	4505                	li	a0,1
     ...
     f2a:	28a50513          	addi	a0,a0,650 # 51b0 <malloc+0x9ba>
     f2e:	00004097          	auipc	ra,0x4
     f32:	80a080e7          	jalr	-2038(ra) # 4738 <printf>
        exit(1);
     f36:	4505                	li	a0,1
...
0000000000000f40 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     f5e:	26e50513          	addi	a0,a0,622 # 51c8 <malloc+0x9d2>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     f76:	27e98993          	addi	s3,s3,638 # 51f0 <malloc+0x9fa>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     f7a:	00004a97          	auipc	s5,0x4
     f7e:	2aea8a93          	addi	s5,s5,686 # 5228 <malloc+0xa32>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     fc4:	20850513          	addi	a0,a0,520 # 51c8 <malloc+0x9d2>
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     fde:	1de58593          	addi	a1,a1,478 # 91b8 <buf>
  ...
  if(unlink("small") < 0){
    ...
    1000:	1cc50513          	addi	a0,a0,460 # 51c8 <malloc+0x9d2>
    ...
    102a:	1aa50513          	addi	a0,a0,426 # 51d0 <malloc+0x9da>
    102e:	00003097          	auipc	ra,0x3
    1032:	70a080e7          	jalr	1802(ra) # 4738 <printf>
    exit(1);
    1036:	4505                	li	a0,1
    ...
    1046:	1be50513          	addi	a0,a0,446 # 5200 <malloc+0xa0a>
    104a:	00003097          	auipc	ra,0x3
    104e:	6ee080e7          	jalr	1774(ra) # 4738 <printf>
      exit(1);
    1052:	4505                	li	a0,1
    ...
    1062:	1da50513          	addi	a0,a0,474 # 5238 <malloc+0xa42>
    1066:	00003097          	auipc	ra,0x3
    106a:	6d2080e7          	jalr	1746(ra) # 4738 <printf>
      exit(1);
    106e:	4505                	li	a0,1
    ...
    107e:	1e650513          	addi	a0,a0,486 # 5260 <malloc+0xa6a>
    1082:	00003097          	auipc	ra,0x3
    1086:	6b6080e7          	jalr	1718(ra) # 4738 <printf>
    exit(1);
    108a:	4505                	li	a0,1
    ...
    109a:	1ea50513          	addi	a0,a0,490 # 5280 <malloc+0xa8a>
    109e:	00003097          	auipc	ra,0x3
    10a2:	69a080e7          	jalr	1690(ra) # 4738 <printf>
    exit(1);
    10a6:	4505                	li	a0,1
    ...
    10b6:	1e650513          	addi	a0,a0,486 # 5298 <malloc+0xaa2>
    10ba:	00003097          	auipc	ra,0x3
    10be:	67e080e7          	jalr	1662(ra) # 4738 <printf>
    exit(1);
    10c2:	4505                	li	a0,1
...
00000000000010cc <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
    ...
    10e8:	1d450513          	addi	a0,a0,468 # 52b8 <malloc+0xac2>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    10fc:	0c090913          	addi	s2,s2,192 # 91b8 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  fd = open("big", O_RDONLY);
    ...
    113a:	18250513          	addi	a0,a0,386 # 52b8 <malloc+0xac2>
  ...
  n = 0;
    ...
    114e:	06e90913          	addi	s2,s2,110 # 91b8 <buf>
  if(fd < 0){
    ...
    1182:	14250513          	addi	a0,a0,322 # 52c0 <malloc+0xaca>
    1186:	00003097          	auipc	ra,0x3
    118a:	5b2080e7          	jalr	1458(ra) # 4738 <printf>
    exit(1);
    118e:	4505                	li	a0,1
    ...
    119e:	14650513          	addi	a0,a0,326 # 52e0 <malloc+0xaea>
    11a2:	00003097          	auipc	ra,0x3
    11a6:	596080e7          	jalr	1430(ra) # 4738 <printf>
      exit(1);
    11aa:	4505                	li	a0,1
    ...
    11ba:	15250513          	addi	a0,a0,338 # 5308 <malloc+0xb12>
    11be:	00003097          	auipc	ra,0x3
    11c2:	57a080e7          	jalr	1402(ra) # 4738 <printf>
    exit(1);
    11c6:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
    ...
    11e6:	0d650513          	addi	a0,a0,214 # 52b8 <malloc+0xac2>
    ...
    1210:	11c50513          	addi	a0,a0,284 # 5328 <malloc+0xb32>
    1214:	00003097          	auipc	ra,0x3
    1218:	524080e7          	jalr	1316(ra) # 4738 <printf>
        exit(1);
    121c:	4505                	li	a0,1
    ...
    122c:	12850513          	addi	a0,a0,296 # 5350 <malloc+0xb5a>
    1230:	00003097          	auipc	ra,0x3
    1234:	508080e7          	jalr	1288(ra) # 4738 <printf>
      exit(1);
    1238:	4505                	li	a0,1
    ...
    1248:	12450513          	addi	a0,a0,292 # 5368 <malloc+0xb72>
    124c:	00003097          	auipc	ra,0x3
    1250:	4ec080e7          	jalr	1260(ra) # 4738 <printf>
      exit(1);
    1254:	4505                	li	a0,1
    ...
    1264:	13050513          	addi	a0,a0,304 # 5390 <malloc+0xb9a>
    1268:	00003097          	auipc	ra,0x3
    126c:	4d0080e7          	jalr	1232(ra) # 4738 <printf>
    exit(1);
    1270:	4505                	li	a0,1
...
000000000000127a <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1292:	72250513          	addi	a0,a0,1826 # 49b0 <malloc+0x1ba>
  ...
  write(fd, "hello", SZ);
    ...
    12aa:	12258593          	addi	a1,a1,290 # 53c8 <malloc+0xbd2>
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    12c6:	6ee50513          	addi	a0,a0,1774 # 49b0 <malloc+0x1ba>
  ...
  if(unlink("unlinkread") != 0){
    ...
    12dc:	6d850513          	addi	a0,a0,1752 # 49b0 <malloc+0x1ba>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    12f2:	6c250513          	addi	a0,a0,1730 # 49b0 <malloc+0x1ba>
  ...
  write(fd1, "yyy", 3);
    ...
    1306:	10e58593          	addi	a1,a1,270 # 5410 <malloc+0xc1a>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
    ...
    1322:	e9a58593          	addi	a1,a1,-358 # 91b8 <buf>
    1326:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
    ...
    136e:	64650513          	addi	a0,a0,1606 # 49b0 <malloc+0x1ba>
    ...
    138e:	01e50513          	addi	a0,a0,30 # 53a8 <malloc+0xbb2>
    1392:	00003097          	auipc	ra,0x3
    1396:	3a6080e7          	jalr	934(ra) # 4738 <printf>
    exit(1);
    139a:	4505                	li	a0,1
    ...
    13aa:	02a50513          	addi	a0,a0,42 # 53d0 <malloc+0xbda>
    13ae:	00003097          	auipc	ra,0x3
    13b2:	38a080e7          	jalr	906(ra) # 4738 <printf>
    exit(1);
    13b6:	4505                	li	a0,1
    ...
    13c6:	02e50513          	addi	a0,a0,46 # 53f0 <malloc+0xbfa>
    13ca:	00003097          	auipc	ra,0x3
    13ce:	36e080e7          	jalr	878(ra) # 4738 <printf>
    exit(1);
    13d2:	4505                	li	a0,1
    ...
    13e2:	03a50513          	addi	a0,a0,58 # 5418 <malloc+0xc22>
    13e6:	00003097          	auipc	ra,0x3
    13ea:	352080e7          	jalr	850(ra) # 4738 <printf>
    exit(1);
    13ee:	4505                	li	a0,1
    ...
    13fe:	03e50513          	addi	a0,a0,62 # 5438 <malloc+0xc42>
    1402:	00003097          	auipc	ra,0x3
    1406:	336080e7          	jalr	822(ra) # 4738 <printf>
    exit(1);
    140a:	4505                	li	a0,1
    ...
    141a:	04250513          	addi	a0,a0,66 # 5458 <malloc+0xc62>
    141e:	00003097          	auipc	ra,0x3
    1422:	31a080e7          	jalr	794(ra) # 4738 <printf>
    exit(1);
    1426:	4505                	li	a0,1
...
0000000000001430 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1442:	a6a78793          	addi	a5,a5,-1430 # 4ea8 <malloc+0x6b2>
    1446:	fcf43023          	sd	a5,-64(s0)
    144a:	00004797          	auipc	a5,0x4
    144e:	02e78793          	addi	a5,a5,46 # 5478 <malloc+0xc82>
    1452:	fcf43423          	sd	a5,-56(s0)
    1456:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    145a:	00004517          	auipc	a0,0x4
    145e:	02650513          	addi	a0,a0,38 # 5480 <malloc+0xc8a>
  ...
  if(pid == 0) {
    ...
    148c:	ff850513          	addi	a0,a0,-8 # 5480 <malloc+0xc8a>
    ...
    14a8:	fe450513          	addi	a0,a0,-28 # 5488 <malloc+0xc92>
    14ac:	00003097          	auipc	ra,0x3
    14b0:	28c080e7          	jalr	652(ra) # 4738 <printf>
      exit(1);
    14b4:	4505                	li	a0,1
    ...
    14c4:	83850513          	addi	a0,a0,-1992 # 4cf8 <malloc+0x502>
    14c8:	00003097          	auipc	ra,0x3
    14cc:	270080e7          	jalr	624(ra) # 4738 <printf>
     exit(1);
    14d0:	4505                	li	a0,1
    ...
    14e0:	a3450513          	addi	a0,a0,-1484 # 4f10 <malloc+0x71a>
    14e4:	00003097          	auipc	ra,0x3
    14e8:	254080e7          	jalr	596(ra) # 4738 <printf>
      exit(1);
    14ec:	4505                	li	a0,1
    ...
    14fe:	9ae50513          	addi	a0,a0,-1618 # 4ea8 <malloc+0x6b2>
  ...
  if(xstatus != 0)
    ...
    1532:	f6a50513          	addi	a0,a0,-150 # 5498 <malloc+0xca2>
    1536:	00003097          	auipc	ra,0x3
    153a:	202080e7          	jalr	514(ra) # 4738 <printf>
      exit(1);
    153e:	4505                	li	a0,1
    ...
    154e:	f6650513          	addi	a0,a0,-154 # 54b0 <malloc+0xcba>
    1552:	00003097          	auipc	ra,0x3
    1556:	1e6080e7          	jalr	486(ra) # 4738 <printf>
    155a:	b7d1                	j	151e <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    155c:	4581                	li	a1,0
    155e:	00004517          	auipc	a0,0x4
    1562:	f2250513          	addi	a0,a0,-222 # 5480 <malloc+0xc8a>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    158c:	cf850513          	addi	a0,a0,-776 # 5280 <malloc+0xa8a>
    1590:	00003097          	auipc	ra,0x3
    1594:	1a8080e7          	jalr	424(ra) # 4738 <printf>
    exit(1);
    1598:	4505                	li	a0,1
    ...
    15a8:	f2450513          	addi	a0,a0,-220 # 54c8 <malloc+0xcd2>
    15ac:	00003097          	auipc	ra,0x3
    15b0:	18c080e7          	jalr	396(ra) # 4738 <printf>
    exit(1);
    15b4:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    15c2:	ec250513          	addi	a0,a0,-318 # 5480 <malloc+0xc8a>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    15ec:	ef850513          	addi	a0,a0,-264 # 54e0 <malloc+0xcea>
    15f0:	00003097          	auipc	ra,0x3
    15f4:	148080e7          	jalr	328(ra) # 4738 <printf>
    exit(1);
    15f8:	4505                	li	a0,1
...
000000000000160c <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    161c:	ee050513          	addi	a0,a0,-288 # 54f8 <malloc+0xd02>
  ...
  fd = open("bigarg-ok", 0);
    ...
    164e:	eae50513          	addi	a0,a0,-338 # 54f8 <malloc+0xd02>
  ...
  close(fd);
    ...
    1674:	33878793          	addi	a5,a5,824 # 69a8 <args.1699>
    1678:	00005697          	auipc	a3,0x5
    167c:	42868693          	addi	a3,a3,1064 # 6aa0 <args.1699+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    1680:	00004717          	auipc	a4,0x4
    1684:	e8870713          	addi	a4,a4,-376 # 5508 <malloc+0xd12>
    ...
    16d8:	f1450513          	addi	a0,a0,-236 # 55e8 <malloc+0xdf2>
    16dc:	00003097          	auipc	ra,0x3
    16e0:	05c080e7          	jalr	92(ra) # 4738 <printf>
    exit(1);
    16e4:	4505                	li	a0,1
    ...
    16fc:	f1050513          	addi	a0,a0,-240 # 5608 <malloc+0xe12>
    1700:	00003097          	auipc	ra,0x3
    1704:	038080e7          	jalr	56(ra) # 4738 <printf>
    exit(1);
    1708:	4505                	li	a0,1
...
badarg(char *s)
{
    ...
    1722:	35048493          	addi	s1,s1,848 # c350 <__BSS_END__+0x188>
  for(int i = 0; i < 50000; i++){
    ...
    1730:	77c98993          	addi	s3,s3,1916 # 4ea8 <malloc+0x6b2>
    argv[0] = (char*)0xffffffff;
...
0000000000001758 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    17a4:	a18a8a93          	addi	s5,s5,-1512 # 91b8 <buf>
      if(cc > sizeof(buf))
    ...
    17c2:	9fa70713          	addi	a4,a4,-1542 # 91b8 <buf>
    ...
    17fa:	e3250513          	addi	a0,a0,-462 # 5628 <malloc+0xe32>
    17fe:	00003097          	auipc	ra,0x3
    1802:	f3a080e7          	jalr	-198(ra) # 4738 <printf>
    exit(1);
    1806:	4505                	li	a0,1
    ...
    1820:	99cb0b13          	addi	s6,s6,-1636 # 91b8 <buf>
    ...
    1834:	42da8a93          	addi	s5,s5,1069 # 142d <unlinkread+0x1b3>
{
    ...
    1880:	dc450513          	addi	a0,a0,-572 # 5640 <malloc+0xe4a>
    1884:	00003097          	auipc	ra,0x3
    1888:	eb4080e7          	jalr	-332(ra) # 4738 <printf>
        exit(1);
    188c:	4505                	li	a0,1
    ...
    189c:	dc050513          	addi	a0,a0,-576 # 5658 <malloc+0xe62>
    18a0:	00003097          	auipc	ra,0x3
    18a4:	e98080e7          	jalr	-360(ra) # 4738 <printf>
}
    ...
    18ce:	da650513          	addi	a0,a0,-602 # 5670 <malloc+0xe7a>
    18d2:	00003097          	auipc	ra,0x3
    18d6:	e66080e7          	jalr	-410(ra) # 4738 <printf>
      exit(1);
    18da:	4505                	li	a0,1
    ...
    190e:	d8650513          	addi	a0,a0,-634 # 5690 <malloc+0xe9a>
    1912:	00003097          	auipc	ra,0x3
    1916:	e26080e7          	jalr	-474(ra) # 4738 <printf>
    exit(1);
    191a:	4505                	li	a0,1
...
0000000000001924 <pgbug>:
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    1936:	0564b483          	ld	s1,86(s1) # 6988 <__SDATA_BEGIN__>
...
000000000000195c <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    1984:	3e050513          	addi	a0,a0,992 # 4d60 <malloc+0x56a>
    1988:	00003097          	auipc	ra,0x3
    198c:	db0080e7          	jalr	-592(ra) # 4738 <printf>
    exit(1);
    1990:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    19b2:	34a50513          	addi	a0,a0,842 # 4cf8 <malloc+0x502>
    19b6:	00003097          	auipc	ra,0x3
    19ba:	d82080e7          	jalr	-638(ra) # 4738 <printf>
    exit(1);
    19be:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    19f6:	cb658593          	addi	a1,a1,-842 # 56a8 <malloc+0xeb2>
    ...
    1a20:	2dc50513          	addi	a0,a0,732 # 4cf8 <malloc+0x502>
    1a24:	00003097          	auipc	ra,0x3
    1a28:	d14080e7          	jalr	-748(ra) # 4738 <printf>
     exit(1);
    1a2c:	4505                	li	a0,1
    ...
    1a3a:	c7a50513          	addi	a0,a0,-902 # 56b0 <malloc+0xeba>
    1a3e:	00003097          	auipc	ra,0x3
    1a42:	cfa080e7          	jalr	-774(ra) # 4738 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    1a5a:	76258593          	addi	a1,a1,1890 # 91b8 <buf>
    ...
    1a74:	c5850513          	addi	a0,a0,-936 # 56c8 <malloc+0xed2>
    1a78:	00003097          	auipc	ra,0x3
    1a7c:	cc0080e7          	jalr	-832(ra) # 4738 <printf>
}
  ...
  printf("kill... ");
    ...
    1aa0:	c4450513          	addi	a0,a0,-956 # 56e0 <malloc+0xeea>
    1aa4:	00003097          	auipc	ra,0x3
    1aa8:	c94080e7          	jalr	-876(ra) # 4738 <printf>
  kill(pid1);
    1aac:	854e                	mv	a0,s3
  ...
  printf("wait... ");
    ...
    1ace:	c2650513          	addi	a0,a0,-986 # 56f0 <malloc+0xefa>
    1ad2:	00003097          	auipc	ra,0x3
    1ad6:	c66080e7          	jalr	-922(ra) # 4738 <printf>
  wait(0);
    1ada:	4501                	li	a0,0
...
0000000000001afa <reparent>:
{
  ...
  exit(0);
    ...
    1b4e:	1ae50513          	addi	a0,a0,430 # 4cf8 <malloc+0x502>
    1b52:	00003097          	auipc	ra,0x3
    1b56:	be6080e7          	jalr	-1050(ra) # 4738 <printf>
      exit(1);
    1b5a:	4505                	li	a0,1
    ...
    1b6a:	1c250513          	addi	a0,a0,450 # 4d28 <malloc+0x532>
    1b6e:	00003097          	auipc	ra,0x3
    1b72:	bca080e7          	jalr	-1078(ra) # 4738 <printf>
        exit(1);
    1b76:	4505                	li	a0,1
...
0000000000001baa <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    1bd2:	c28080e7          	jalr	-984(ra) # 47f6 <malloc>
    ...
    1c12:	af250513          	addi	a0,a0,-1294 # 5700 <malloc+0xf0a>
    1c16:	00003097          	auipc	ra,0x3
    1c1a:	b22080e7          	jalr	-1246(ra) # 4738 <printf>
      exit(1);
    1c1e:	4505                	li	a0,1
...
0000000000001c40 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    1cd6:	a4e50513          	addi	a0,a0,-1458 # 5720 <malloc+0xf2a>
    1cda:	00003097          	auipc	ra,0x3
    1cde:	a5e080e7          	jalr	-1442(ra) # 4738 <printf>
    exit(1);
    1ce2:	4505                	li	a0,1
    ...
    1cf2:	a5a50513          	addi	a0,a0,-1446 # 5748 <malloc+0xf52>
    1cf6:	00003097          	auipc	ra,0x3
    1cfa:	a42080e7          	jalr	-1470(ra) # 4738 <printf>
      exit(1);
    1cfe:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    1d36:	cb650513          	addi	a0,a0,-842 # 49e8 <malloc+0x1f2>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    1d76:	9f650513          	addi	a0,a0,-1546 # 5768 <malloc+0xf72>
    1d7a:	00003097          	auipc	ra,0x3
    1d7e:	9be080e7          	jalr	-1602(ra) # 4738 <printf>
    exit(1);
    1d82:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    1db2:	c3a50513          	addi	a0,a0,-966 # 49e8 <malloc+0x1f2>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    1dd8:	9bc50513          	addi	a0,a0,-1604 # 5790 <malloc+0xf9a>
    1ddc:	00003097          	auipc	ra,0x3
    1de0:	95c080e7          	jalr	-1700(ra) # 4738 <printf>
    exit(1);
    1de4:	4505                	li	a0,1
...
0000000000001df8 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    1e1c:	ac878793          	addi	a5,a5,-1336 # 48e0 <malloc+0xea>
    1e20:	f6f43823          	sd	a5,-144(s0)
    1e24:	00003797          	auipc	a5,0x3
    1e28:	ac478793          	addi	a5,a5,-1340 # 48e8 <malloc+0xf2>
    1e2c:	f6f43c23          	sd	a5,-136(s0)
    1e30:	00003797          	auipc	a5,0x3
    1e34:	ac078793          	addi	a5,a5,-1344 # 48f0 <malloc+0xfa>
    1e38:	f8f43023          	sd	a5,-128(s0)
    1e3c:	00003797          	auipc	a5,0x3
    1e40:	abc78793          	addi	a5,a5,-1348 # 48f8 <malloc+0x102>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    1e9a:	322a0a13          	addi	s4,s4,802 # 91b8 <buf>
    1e9e:	00007a97          	auipc	s5,0x7
    1ea2:	31ba8a93          	addi	s5,s5,795 # 91b9 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    1eb8:	74450513          	addi	a0,a0,1860 # 55f8 <malloc+0xe02>
    1ebc:	00003097          	auipc	ra,0x3
    1ec0:	87c080e7          	jalr	-1924(ra) # 4738 <printf>
      exit(1);
    1ec4:	4505                	li	a0,1
    ...
    1f32:	87a50513          	addi	a0,a0,-1926 # 57a8 <malloc+0xfb2>
    1f36:	00003097          	auipc	ra,0x3
    1f3a:	802080e7          	jalr	-2046(ra) # 4738 <printf>
        exit(1);
    1f3e:	4505                	li	a0,1
    ...
    1f4c:	87050513          	addi	a0,a0,-1936 # 57b8 <malloc+0xfc2>
    1f50:	00002097          	auipc	ra,0x2
    1f54:	7e8080e7          	jalr	2024(ra) # 4738 <printf>
          exit(1);
    1f58:	4505                	li	a0,1
    ...
    1f70:	86450513          	addi	a0,a0,-1948 # 57d0 <malloc+0xfda>
    1f74:	00002097          	auipc	ra,0x2
    1f78:	7c4080e7          	jalr	1988(ra) # 4738 <printf>
          exit(1);
    1f7c:	4505                	li	a0,1
    ...
    1fa0:	21c78793          	addi	a5,a5,540 # 91b8 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    2000:	7e450513          	addi	a0,a0,2020 # 57e0 <malloc+0xfea>
    2004:	00002097          	auipc	ra,0x2
    2008:	734080e7          	jalr	1844(ra) # 4738 <printf>
      exit(1);
    200c:	4505                	li	a0,1
...
0000000000002034 <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    2074:	14890913          	addi	s2,s2,328 # 91b8 <buf>
  for(i = 0; i < N; i++){
    2078:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile", 0);
    ...
    20bc:	a8050513          	addi	a0,a0,-1408 # 4b38 <malloc+0x342>
  ...
  for(i = 0; ; i++){
    ...
    20d2:	0ea90913          	addi	s2,s2,234 # 91b8 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    2120:	6dc50513          	addi	a0,a0,1756 # 57f8 <malloc+0x1002>
    2124:	00002097          	auipc	ra,0x2
    2128:	614080e7          	jalr	1556(ra) # 4738 <printf>
    exit(1);
    212c:	4505                	li	a0,1
    ...
    213c:	6e050513          	addi	a0,a0,1760 # 5818 <malloc+0x1022>
    2140:	00002097          	auipc	ra,0x2
    2144:	5f8080e7          	jalr	1528(ra) # 4738 <printf>
      exit(1);
    2148:	4505                	li	a0,1
    ...
    2158:	6e450513          	addi	a0,a0,1764 # 5838 <malloc+0x1042>
    215c:	00002097          	auipc	ra,0x2
    2160:	5dc080e7          	jalr	1500(ra) # 4738 <printf>
    exit(1);
    2164:	4505                	li	a0,1
    ...
    2174:	6e850513          	addi	a0,a0,1768 # 5858 <malloc+0x1062>
    2178:	00002097          	auipc	ra,0x2
    217c:	5c0080e7          	jalr	1472(ra) # 4738 <printf>
      exit(1);
    2180:	4505                	li	a0,1
    ...
    2190:	6ec50513          	addi	a0,a0,1772 # 5878 <malloc+0x1082>
    2194:	00002097          	auipc	ra,0x2
    2198:	5a4080e7          	jalr	1444(ra) # 4738 <printf>
      exit(1);
    219c:	4505                	li	a0,1
    ...
    21ac:	6e850513          	addi	a0,a0,1768 # 5890 <malloc+0x109a>
    21b0:	00002097          	auipc	ra,0x2
    21b4:	588080e7          	jalr	1416(ra) # 4738 <printf>
      exit(1);
    21b8:	4505                	li	a0,1
  ...
  unlink("bigfile");
    ...
    21da:	96250513          	addi	a0,a0,-1694 # 4b38 <malloc+0x342>
    ...
    21fe:	6b650513          	addi	a0,a0,1718 # 58b0 <malloc+0x10ba>
    2202:	00002097          	auipc	ra,0x2
    2206:	536080e7          	jalr	1334(ra) # 4738 <printf>
    exit(1);
    220a:	4505                	li	a0,1
...
0000000000002214 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
    ...
    2262:	16a58593          	addi	a1,a1,362 # 53c8 <malloc+0xbd2>
  ...
  if(link("lf1", "lf2") < 0){
    ...
    2282:	65a58593          	addi	a1,a1,1626 # 58d8 <malloc+0x10e2>
    2286:	00003517          	auipc	a0,0x3
    228a:	64a50513          	addi	a0,a0,1610 # 58d0 <malloc+0x10da>
  ...
  unlink("lf1");
    ...
    229e:	63650513          	addi	a0,a0,1590 # 58d0 <malloc+0x10da>
    22a2:	00002097          	auipc	ra,0x2
    22a6:	156080e7          	jalr	342(ra) # 43f8 <unlink>
  if(open("lf1", 0) >= 0){
    22aa:	4581                	li	a1,0
    22ac:	00003517          	auipc	a0,0x3
    22b0:	62450513          	addi	a0,a0,1572 # 58d0 <malloc+0x10da>
  ...
  fd = open("lf2", 0);
    ...
    22c6:	61650513          	addi	a0,a0,1558 # 58d8 <malloc+0x10e2>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
    ...
    22de:	ede58593          	addi	a1,a1,-290 # 91b8 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
    ...
    22fe:	5de58593          	addi	a1,a1,1502 # 58d8 <malloc+0x10e2>
    2302:	852e                	mv	a0,a1
  ...
  unlink("lf2");
    ...
    2314:	5c850513          	addi	a0,a0,1480 # 58d8 <malloc+0x10e2>
    2318:	00002097          	auipc	ra,0x2
    231c:	0e0080e7          	jalr	224(ra) # 43f8 <unlink>
  if(link("lf2", "lf1") >= 0){
    2320:	00003597          	auipc	a1,0x3
    2324:	5b058593          	addi	a1,a1,1456 # 58d0 <malloc+0x10da>
    2328:	00003517          	auipc	a0,0x3
    232c:	5b050513          	addi	a0,a0,1456 # 58d8 <malloc+0x10e2>
  ...
  if(link(".", "lf1") >= 0){
    ...
    2340:	59458593          	addi	a1,a1,1428 # 58d0 <malloc+0x10da>
    2344:	00003517          	auipc	a0,0x3
    2348:	90450513          	addi	a0,a0,-1788 # 4c48 <malloc+0x452>
    ...
    236a:	57a50513          	addi	a0,a0,1402 # 58e0 <malloc+0x10ea>
    236e:	00002097          	auipc	ra,0x2
    2372:	3ca080e7          	jalr	970(ra) # 4738 <printf>
    exit(1);
    2376:	4505                	li	a0,1
    ...
    2386:	57650513          	addi	a0,a0,1398 # 58f8 <malloc+0x1102>
    238a:	00002097          	auipc	ra,0x2
    238e:	3ae080e7          	jalr	942(ra) # 4738 <printf>
    exit(1);
    2392:	4505                	li	a0,1
    ...
    23a2:	57250513          	addi	a0,a0,1394 # 5910 <malloc+0x111a>
    23a6:	00002097          	auipc	ra,0x2
    23aa:	392080e7          	jalr	914(ra) # 4738 <printf>
    exit(1);
    23ae:	4505                	li	a0,1
    ...
    23be:	57650513          	addi	a0,a0,1398 # 5930 <malloc+0x113a>
    23c2:	00002097          	auipc	ra,0x2
    23c6:	376080e7          	jalr	886(ra) # 4738 <printf>
    exit(1);
    23ca:	4505                	li	a0,1
    ...
    23da:	58a50513          	addi	a0,a0,1418 # 5960 <malloc+0x116a>
    23de:	00002097          	auipc	ra,0x2
    23e2:	35a080e7          	jalr	858(ra) # 4738 <printf>
    exit(1);
    23e6:	4505                	li	a0,1
    ...
    23f6:	58650513          	addi	a0,a0,1414 # 5978 <malloc+0x1182>
    23fa:	00002097          	auipc	ra,0x2
    23fe:	33e080e7          	jalr	830(ra) # 4738 <printf>
    exit(1);
    2402:	4505                	li	a0,1
    ...
    2412:	58250513          	addi	a0,a0,1410 # 5990 <malloc+0x119a>
    2416:	00002097          	auipc	ra,0x2
    241a:	322080e7          	jalr	802(ra) # 4738 <printf>
    exit(1);
    241e:	4505                	li	a0,1
    ...
    242e:	58e50513          	addi	a0,a0,1422 # 59b8 <malloc+0x11c2>
    2432:	00002097          	auipc	ra,0x2
    2436:	306080e7          	jalr	774(ra) # 4738 <printf>
    exit(1);
    243a:	4505                	li	a0,1
    ...
    244a:	59a50513          	addi	a0,a0,1434 # 59e0 <malloc+0x11ea>
    244e:	00002097          	auipc	ra,0x2
    2452:	2ea080e7          	jalr	746(ra) # 4738 <printf>
    exit(1);
    2456:	4505                	li	a0,1
...
0000000000002460 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    248e:	576b8b93          	addi	s7,s7,1398 # 5a00 <malloc+0x120a>
  for(i = 0; i < N; i++){
    ...
    24d0:	53c50513          	addi	a0,a0,1340 # 5a08 <malloc+0x1212>
    24d4:	00002097          	auipc	ra,0x2
    24d8:	264080e7          	jalr	612(ra) # 4738 <printf>
        exit(1);
    24dc:	4505                	li	a0,1
    ...
    24ee:	51650513          	addi	a0,a0,1302 # 5a00 <malloc+0x120a>
  ...
  fd = open(".", 0);
    ...
    2526:	72650513          	addi	a0,a0,1830 # 4c48 <malloc+0x452>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    254c:	4e050513          	addi	a0,a0,1248 # 5a28 <malloc+0x1232>
    2550:	00002097          	auipc	ra,0x2
    2554:	1e8080e7          	jalr	488(ra) # 4738 <printf>
        exit(1);
    2558:	4505                	li	a0,1
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    25bc:	49050513          	addi	a0,a0,1168 # 5a48 <malloc+0x1252>
    25c0:	00002097          	auipc	ra,0x2
    25c4:	178080e7          	jalr	376(ra) # 4738 <printf>
        exit(1);
    25c8:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    25f4:	48050513          	addi	a0,a0,1152 # 5a70 <malloc+0x127a>
    25f8:	00002097          	auipc	ra,0x2
    25fc:	140080e7          	jalr	320(ra) # 4738 <printf>
    exit(1);
    2600:	4505                	li	a0,1
    ...
    2610:	6ec50513          	addi	a0,a0,1772 # 4cf8 <malloc+0x502>
    2614:	00002097          	auipc	ra,0x2
    2618:	124080e7          	jalr	292(ra) # 4738 <printf>
      exit(1);
    261c:	4505                	li	a0,1
...
0000000000002776 <linkunlink>:
{
  ...
  unlink("x");
    ...
    2796:	f1650513          	addi	a0,a0,-234 # 56a8 <malloc+0xeb2>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    27d2:	edaa8a93          	addi	s5,s5,-294 # 56a8 <malloc+0xeb2>
      link("cat", "x");
    27d6:	00003b97          	auipc	s7,0x3
    27da:	2d2b8b93          	addi	s7,s7,722 # 5aa8 <malloc+0x12b2>
    27de:	a091                	j	2822 <linkunlink+0xac>
    printf("%s: fork failed\n", s);
    27e0:	85a6                	mv	a1,s1
    27e2:	00002517          	auipc	a0,0x2
    27e6:	51650513          	addi	a0,a0,1302 # 4cf8 <malloc+0x502>
    27ea:	00002097          	auipc	ra,0x2
    27ee:	f4e080e7          	jalr	-178(ra) # 4738 <printf>
    exit(1);
    27f2:	4505                	li	a0,1
...
0000000000002878 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    28c8:	1eca0a13          	addi	s4,s4,492 # 5ab0 <malloc+0x12ba>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    291a:	19a50513          	addi	a0,a0,410 # 5ab0 <malloc+0x12ba>
  ...
  for(i = 0; i < N; i++){
    ...
    298a:	13250513          	addi	a0,a0,306 # 5ab8 <malloc+0x12c2>
    298e:	00002097          	auipc	ra,0x2
    2992:	daa080e7          	jalr	-598(ra) # 4738 <printf>
    exit(1);
    2996:	4505                	li	a0,1
    ...
    29a6:	13650513          	addi	a0,a0,310 # 5ad8 <malloc+0x12e2>
    29aa:	00002097          	auipc	ra,0x2
    29ae:	d8e080e7          	jalr	-626(ra) # 4738 <printf>
      exit(1);
    29b2:	4505                	li	a0,1
    ...
    29c2:	13250513          	addi	a0,a0,306 # 5af0 <malloc+0x12fa>
    29c6:	00002097          	auipc	ra,0x2
    29ca:	d72080e7          	jalr	-654(ra) # 4738 <printf>
      exit(1);
    29ce:	4505                	li	a0,1
...
00000000000029d8 <subdir>:
{
  ...
  unlink("ff");
    ...
    29ea:	25a50513          	addi	a0,a0,602 # 5c40 <malloc+0x144a>
    29ee:	00002097          	auipc	ra,0x2
    29f2:	a0a080e7          	jalr	-1526(ra) # 43f8 <unlink>
  if(mkdir("dd") != 0){
    29f6:	00003517          	auipc	a0,0x3
    29fa:	11a50513          	addi	a0,a0,282 # 5b10 <malloc+0x131a>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    2a12:	12250513          	addi	a0,a0,290 # 5b30 <malloc+0x133a>
  ...
  write(fd, "ff", 2);
    ...
    2a2a:	21a58593          	addi	a1,a1,538 # 5c40 <malloc+0x144a>
  ...
  if(unlink("dd") >= 0){
    ...
    2a44:	0d050513          	addi	a0,a0,208 # 5b10 <malloc+0x131a>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    2a58:	13450513          	addi	a0,a0,308 # 5b88 <malloc+0x1392>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2a70:	14450513          	addi	a0,a0,324 # 5bb0 <malloc+0x13ba>
  ...
  write(fd, "FF", 2);
    ...
    2a88:	15c58593          	addi	a1,a1,348 # 5be0 <malloc+0x13ea>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2aa4:	14850513          	addi	a0,a0,328 # 5be8 <malloc+0x13f2>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    2abc:	70058593          	addi	a1,a1,1792 # 91b8 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    2ad2:	6ea74703          	lbu	a4,1770(a4) # 91b8 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    2aec:	15058593          	addi	a1,a1,336 # 5c38 <malloc+0x1442>
    2af0:	00003517          	auipc	a0,0x3
    2af4:	0c050513          	addi	a0,a0,192 # 5bb0 <malloc+0x13ba>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    2b08:	0ac50513          	addi	a0,a0,172 # 5bb0 <malloc+0x13ba>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2b1e:	09650513          	addi	a0,a0,150 # 5bb0 <malloc+0x13ba>
  ...
  if(chdir("dd") != 0){
    ...
    2b32:	fe250513          	addi	a0,a0,-30 # 5b10 <malloc+0x131a>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    2b46:	18e50513          	addi	a0,a0,398 # 5cd0 <malloc+0x14da>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    2b5a:	1aa50513          	addi	a0,a0,426 # 5d00 <malloc+0x150a>
  ...
  if(chdir("./..") != 0){
    ...
    2b6e:	1c650513          	addi	a0,a0,454 # 5d30 <malloc+0x153a>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    2b84:	0b850513          	addi	a0,a0,184 # 5c38 <malloc+0x1442>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    2b9c:	62058593          	addi	a1,a1,1568 # 91b8 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2bbe:	ff650513          	addi	a0,a0,-10 # 5bb0 <malloc+0x13ba>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2bd6:	1ee50513          	addi	a0,a0,494 # 5dc0 <malloc+0x15ca>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2bee:	20650513          	addi	a0,a0,518 # 5df0 <malloc+0x15fa>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    2c06:	f0e50513          	addi	a0,a0,-242 # 5b10 <malloc+0x131a>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    2c1c:	ef850513          	addi	a0,a0,-264 # 5b10 <malloc+0x131a>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    2c32:	ee250513          	addi	a0,a0,-286 # 5b10 <malloc+0x131a>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    2c46:	23e58593          	addi	a1,a1,574 # 5e80 <malloc+0x168a>
    2c4a:	00003517          	auipc	a0,0x3
    2c4e:	17650513          	addi	a0,a0,374 # 5dc0 <malloc+0x15ca>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    2c62:	22258593          	addi	a1,a1,546 # 5e80 <malloc+0x168a>
    2c66:	00003517          	auipc	a0,0x3
    2c6a:	18a50513          	addi	a0,a0,394 # 5df0 <malloc+0x15fa>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2c7e:	fbe58593          	addi	a1,a1,-66 # 5c38 <malloc+0x1442>
    2c82:	00003517          	auipc	a0,0x3
    2c86:	eae50513          	addi	a0,a0,-338 # 5b30 <malloc+0x133a>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2c9a:	12a50513          	addi	a0,a0,298 # 5dc0 <malloc+0x15ca>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2cae:	14650513          	addi	a0,a0,326 # 5df0 <malloc+0x15fa>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2cc2:	f7a50513          	addi	a0,a0,-134 # 5c38 <malloc+0x1442>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2cd6:	11e50513          	addi	a0,a0,286 # 5df0 <malloc+0x15fa>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2cea:	0da50513          	addi	a0,a0,218 # 5dc0 <malloc+0x15ca>
  ...
  if(chdir("dd/ff") == 0){
    ...
    2cfe:	e3650513          	addi	a0,a0,-458 # 5b30 <malloc+0x133a>
  ...
  if(chdir("dd/xx") == 0){
    ...
    2d12:	2c250513          	addi	a0,a0,706 # 5fd0 <malloc+0x17da>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    2d26:	f1650513          	addi	a0,a0,-234 # 5c38 <malloc+0x1442>
  ...
  if(unlink("dd/ff") != 0){
    ...
    2d3a:	dfa50513          	addi	a0,a0,-518 # 5b30 <malloc+0x133a>
  ...
  if(unlink("dd") == 0){
    ...
    2d4e:	dc650513          	addi	a0,a0,-570 # 5b10 <malloc+0x131a>
  ...
  if(unlink("dd/dd") < 0){
    ...
    2d62:	2e250513          	addi	a0,a0,738 # 6040 <malloc+0x184a>
  ...
  if(unlink("dd") < 0){
    ...
    2d76:	d9e50513          	addi	a0,a0,-610 # 5b10 <malloc+0x131a>
    ...
    2d98:	d8450513          	addi	a0,a0,-636 # 5b18 <malloc+0x1322>
    2d9c:	00002097          	auipc	ra,0x2
    2da0:	99c080e7          	jalr	-1636(ra) # 4738 <printf>
    exit(1);
    2da4:	4505                	li	a0,1
    ...
    2db4:	d8850513          	addi	a0,a0,-632 # 5b38 <malloc+0x1342>
    2db8:	00002097          	auipc	ra,0x2
    2dbc:	980080e7          	jalr	-1664(ra) # 4738 <printf>
    exit(1);
    2dc0:	4505                	li	a0,1
    ...
    2dd0:	d8c50513          	addi	a0,a0,-628 # 5b58 <malloc+0x1362>
    2dd4:	00002097          	auipc	ra,0x2
    2dd8:	964080e7          	jalr	-1692(ra) # 4738 <printf>
    exit(1);
    2ddc:	4505                	li	a0,1
    ...
    2dec:	da850513          	addi	a0,a0,-600 # 5b90 <malloc+0x139a>
    2df0:	00002097          	auipc	ra,0x2
    2df4:	948080e7          	jalr	-1720(ra) # 4738 <printf>
    exit(1);
    2df8:	4505                	li	a0,1
    ...
    2e08:	dbc50513          	addi	a0,a0,-580 # 5bc0 <malloc+0x13ca>
    2e0c:	00002097          	auipc	ra,0x2
    2e10:	92c080e7          	jalr	-1748(ra) # 4738 <printf>
    exit(1);
    2e14:	4505                	li	a0,1
    ...
    2e24:	dd850513          	addi	a0,a0,-552 # 5bf8 <malloc+0x1402>
    2e28:	00002097          	auipc	ra,0x2
    2e2c:	910080e7          	jalr	-1776(ra) # 4738 <printf>
    exit(1);
    2e30:	4505                	li	a0,1
    ...
    2e40:	ddc50513          	addi	a0,a0,-548 # 5c18 <malloc+0x1422>
    2e44:	00002097          	auipc	ra,0x2
    2e48:	8f4080e7          	jalr	-1804(ra) # 4738 <printf>
    exit(1);
    2e4c:	4505                	li	a0,1
    ...
    2e5c:	df050513          	addi	a0,a0,-528 # 5c48 <malloc+0x1452>
    2e60:	00002097          	auipc	ra,0x2
    2e64:	8d8080e7          	jalr	-1832(ra) # 4738 <printf>
    exit(1);
    2e68:	4505                	li	a0,1
    ...
    2e78:	dfc50513          	addi	a0,a0,-516 # 5c70 <malloc+0x147a>
    2e7c:	00002097          	auipc	ra,0x2
    2e80:	8bc080e7          	jalr	-1860(ra) # 4738 <printf>
    exit(1);
    2e84:	4505                	li	a0,1
    ...
    2e94:	e0050513          	addi	a0,a0,-512 # 5c90 <malloc+0x149a>
    2e98:	00002097          	auipc	ra,0x2
    2e9c:	8a0080e7          	jalr	-1888(ra) # 4738 <printf>
    exit(1);
    2ea0:	4505                	li	a0,1
    ...
    2eb0:	e0c50513          	addi	a0,a0,-500 # 5cb8 <malloc+0x14c2>
    2eb4:	00002097          	auipc	ra,0x2
    2eb8:	884080e7          	jalr	-1916(ra) # 4738 <printf>
    exit(1);
    2ebc:	4505                	li	a0,1
    ...
    2ecc:	e1850513          	addi	a0,a0,-488 # 5ce0 <malloc+0x14ea>
    2ed0:	00002097          	auipc	ra,0x2
    2ed4:	868080e7          	jalr	-1944(ra) # 4738 <printf>
    exit(1);
    2ed8:	4505                	li	a0,1
    ...
    2ee8:	e2c50513          	addi	a0,a0,-468 # 5d10 <malloc+0x151a>
    2eec:	00002097          	auipc	ra,0x2
    2ef0:	84c080e7          	jalr	-1972(ra) # 4738 <printf>
    exit(1);
    2ef4:	4505                	li	a0,1
    ...
    2f04:	e3850513          	addi	a0,a0,-456 # 5d38 <malloc+0x1542>
    2f08:	00002097          	auipc	ra,0x2
    2f0c:	830080e7          	jalr	-2000(ra) # 4738 <printf>
    exit(1);
    2f10:	4505                	li	a0,1
    ...
    2f20:	e3450513          	addi	a0,a0,-460 # 5d50 <malloc+0x155a>
    2f24:	00002097          	auipc	ra,0x2
    2f28:	814080e7          	jalr	-2028(ra) # 4738 <printf>
    exit(1);
    2f2c:	4505                	li	a0,1
    ...
    2f3c:	e3850513          	addi	a0,a0,-456 # 5d70 <malloc+0x157a>
    2f40:	00001097          	auipc	ra,0x1
    2f44:	7f8080e7          	jalr	2040(ra) # 4738 <printf>
    exit(1);
    2f48:	4505                	li	a0,1
    ...
    2f58:	e3c50513          	addi	a0,a0,-452 # 5d90 <malloc+0x159a>
    2f5c:	00001097          	auipc	ra,0x1
    2f60:	7dc080e7          	jalr	2012(ra) # 4738 <printf>
    exit(1);
    2f64:	4505                	li	a0,1
    ...
    2f74:	e6050513          	addi	a0,a0,-416 # 5dd0 <malloc+0x15da>
    2f78:	00001097          	auipc	ra,0x1
    2f7c:	7c0080e7          	jalr	1984(ra) # 4738 <printf>
    exit(1);
    2f80:	4505                	li	a0,1
    ...
    2f90:	e7450513          	addi	a0,a0,-396 # 5e00 <malloc+0x160a>
    2f94:	00001097          	auipc	ra,0x1
    2f98:	7a4080e7          	jalr	1956(ra) # 4738 <printf>
    exit(1);
    2f9c:	4505                	li	a0,1
    ...
    2fac:	e7850513          	addi	a0,a0,-392 # 5e20 <malloc+0x162a>
    2fb0:	00001097          	auipc	ra,0x1
    2fb4:	788080e7          	jalr	1928(ra) # 4738 <printf>
    exit(1);
    2fb8:	4505                	li	a0,1
    ...
    2fc8:	e7c50513          	addi	a0,a0,-388 # 5e40 <malloc+0x164a>
    2fcc:	00001097          	auipc	ra,0x1
    2fd0:	76c080e7          	jalr	1900(ra) # 4738 <printf>
    exit(1);
    2fd4:	4505                	li	a0,1
    ...
    2fe4:	e8050513          	addi	a0,a0,-384 # 5e60 <malloc+0x166a>
    2fe8:	00001097          	auipc	ra,0x1
    2fec:	750080e7          	jalr	1872(ra) # 4738 <printf>
    exit(1);
    2ff0:	4505                	li	a0,1
    ...
    3000:	e9450513          	addi	a0,a0,-364 # 5e90 <malloc+0x169a>
    3004:	00001097          	auipc	ra,0x1
    3008:	734080e7          	jalr	1844(ra) # 4738 <printf>
    exit(1);
    300c:	4505                	li	a0,1
    ...
    301c:	ea050513          	addi	a0,a0,-352 # 5eb8 <malloc+0x16c2>
    3020:	00001097          	auipc	ra,0x1
    3024:	718080e7          	jalr	1816(ra) # 4738 <printf>
    exit(1);
    3028:	4505                	li	a0,1
    ...
    3038:	eac50513          	addi	a0,a0,-340 # 5ee0 <malloc+0x16ea>
    303c:	00001097          	auipc	ra,0x1
    3040:	6fc080e7          	jalr	1788(ra) # 4738 <printf>
    exit(1);
    3044:	4505                	li	a0,1
    ...
    3054:	eb850513          	addi	a0,a0,-328 # 5f08 <malloc+0x1712>
    3058:	00001097          	auipc	ra,0x1
    305c:	6e0080e7          	jalr	1760(ra) # 4738 <printf>
    exit(1);
    3060:	4505                	li	a0,1
    ...
    3070:	ebc50513          	addi	a0,a0,-324 # 5f28 <malloc+0x1732>
    3074:	00001097          	auipc	ra,0x1
    3078:	6c4080e7          	jalr	1732(ra) # 4738 <printf>
    exit(1);
    307c:	4505                	li	a0,1
    ...
    308c:	ec050513          	addi	a0,a0,-320 # 5f48 <malloc+0x1752>
    3090:	00001097          	auipc	ra,0x1
    3094:	6a8080e7          	jalr	1704(ra) # 4738 <printf>
    exit(1);
    3098:	4505                	li	a0,1
    ...
    30a8:	ecc50513          	addi	a0,a0,-308 # 5f70 <malloc+0x177a>
    30ac:	00001097          	auipc	ra,0x1
    30b0:	68c080e7          	jalr	1676(ra) # 4738 <printf>
    exit(1);
    30b4:	4505                	li	a0,1
    ...
    30c4:	ed050513          	addi	a0,a0,-304 # 5f90 <malloc+0x179a>
    30c8:	00001097          	auipc	ra,0x1
    30cc:	670080e7          	jalr	1648(ra) # 4738 <printf>
    exit(1);
    30d0:	4505                	li	a0,1
    ...
    30e0:	ed450513          	addi	a0,a0,-300 # 5fb0 <malloc+0x17ba>
    30e4:	00001097          	auipc	ra,0x1
    30e8:	654080e7          	jalr	1620(ra) # 4738 <printf>
    exit(1);
    30ec:	4505                	li	a0,1
    ...
    30fc:	ee050513          	addi	a0,a0,-288 # 5fd8 <malloc+0x17e2>
    3100:	00001097          	auipc	ra,0x1
    3104:	638080e7          	jalr	1592(ra) # 4738 <printf>
    exit(1);
    3108:	4505                	li	a0,1
    ...
    3118:	b5c50513          	addi	a0,a0,-1188 # 5c70 <malloc+0x147a>
    311c:	00001097          	auipc	ra,0x1
    3120:	61c080e7          	jalr	1564(ra) # 4738 <printf>
    exit(1);
    3124:	4505                	li	a0,1
    ...
    3134:	ec850513          	addi	a0,a0,-312 # 5ff8 <malloc+0x1802>
    3138:	00001097          	auipc	ra,0x1
    313c:	600080e7          	jalr	1536(ra) # 4738 <printf>
    exit(1);
    3140:	4505                	li	a0,1
    ...
    3150:	ecc50513          	addi	a0,a0,-308 # 6018 <malloc+0x1822>
    3154:	00001097          	auipc	ra,0x1
    3158:	5e4080e7          	jalr	1508(ra) # 4738 <printf>
    exit(1);
    315c:	4505                	li	a0,1
    ...
    316c:	ee050513          	addi	a0,a0,-288 # 6048 <malloc+0x1852>
    3170:	00001097          	auipc	ra,0x1
    3174:	5c8080e7          	jalr	1480(ra) # 4738 <printf>
    exit(1);
    3178:	4505                	li	a0,1
    ...
    3188:	ee450513          	addi	a0,a0,-284 # 6068 <malloc+0x1872>
    318c:	00001097          	auipc	ra,0x1
    3190:	5ac080e7          	jalr	1452(ra) # 4738 <printf>
    exit(1);
    3194:	4505                	li	a0,1
...
000000000000319e <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    31b4:	99050513          	addi	a0,a0,-1648 # 4b40 <malloc+0x34a>
  ...
  if(chdir("dirfile") == 0){
    ...
    31d0:	97450513          	addi	a0,a0,-1676 # 4b40 <malloc+0x34a>
  ...
  fd = open("dirfile/xx", 0);
    ...
    31e4:	ee050513          	addi	a0,a0,-288 # 60c0 <malloc+0x18ca>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    31fc:	ec850513          	addi	a0,a0,-312 # 60c0 <malloc+0x18ca>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3210:	eb450513          	addi	a0,a0,-332 # 60c0 <malloc+0x18ca>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3224:	ea050513          	addi	a0,a0,-352 # 60c0 <malloc+0x18ca>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3238:	e8c58593          	addi	a1,a1,-372 # 60c0 <malloc+0x18ca>
    323c:	00003517          	auipc	a0,0x3
    3240:	f0c50513          	addi	a0,a0,-244 # 6148 <malloc+0x1952>
  ...
  if(unlink("dirfile") != 0){
    ...
    3254:	8f050513          	addi	a0,a0,-1808 # 4b40 <malloc+0x34a>
  ...
  fd = open(".", O_RDWR);
    ...
    326a:	9e250513          	addi	a0,a0,-1566 # 4c48 <malloc+0x452>
  ...
  fd = open(".", 0);
    ...
    3280:	9cc50513          	addi	a0,a0,-1588 # 4c48 <malloc+0x452>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3294:	41858593          	addi	a1,a1,1048 # 56a8 <malloc+0xeb2>
  ...
  close(fd);
    ...
    32c0:	dc450513          	addi	a0,a0,-572 # 6080 <malloc+0x188a>
    32c4:	00001097          	auipc	ra,0x1
    32c8:	474080e7          	jalr	1140(ra) # 4738 <printf>
    exit(1);
    32cc:	4505                	li	a0,1
    ...
    32dc:	dc850513          	addi	a0,a0,-568 # 60a0 <malloc+0x18aa>
    32e0:	00001097          	auipc	ra,0x1
    32e4:	458080e7          	jalr	1112(ra) # 4738 <printf>
    exit(1);
    32e8:	4505                	li	a0,1
    ...
    32f8:	ddc50513          	addi	a0,a0,-548 # 60d0 <malloc+0x18da>
    32fc:	00001097          	auipc	ra,0x1
    3300:	43c080e7          	jalr	1084(ra) # 4738 <printf>
    exit(1);
    3304:	4505                	li	a0,1
    ...
    3314:	dc050513          	addi	a0,a0,-576 # 60d0 <malloc+0x18da>
    3318:	00001097          	auipc	ra,0x1
    331c:	420080e7          	jalr	1056(ra) # 4738 <printf>
    exit(1);
    3320:	4505                	li	a0,1
    ...
    3330:	dcc50513          	addi	a0,a0,-564 # 60f8 <malloc+0x1902>
    3334:	00001097          	auipc	ra,0x1
    3338:	404080e7          	jalr	1028(ra) # 4738 <printf>
    exit(1);
    333c:	4505                	li	a0,1
    ...
    334c:	dd850513          	addi	a0,a0,-552 # 6120 <malloc+0x192a>
    3350:	00001097          	auipc	ra,0x1
    3354:	3e8080e7          	jalr	1000(ra) # 4738 <printf>
    exit(1);
    3358:	4505                	li	a0,1
    ...
    3368:	dec50513          	addi	a0,a0,-532 # 6150 <malloc+0x195a>
    336c:	00001097          	auipc	ra,0x1
    3370:	3cc080e7          	jalr	972(ra) # 4738 <printf>
    exit(1);
    3374:	4505                	li	a0,1
    ...
    3384:	df850513          	addi	a0,a0,-520 # 6178 <malloc+0x1982>
    3388:	00001097          	auipc	ra,0x1
    338c:	3b0080e7          	jalr	944(ra) # 4738 <printf>
    exit(1);
    3390:	4505                	li	a0,1
    ...
    33a0:	dfc50513          	addi	a0,a0,-516 # 6198 <malloc+0x19a2>
    33a4:	00001097          	auipc	ra,0x1
    33a8:	394080e7          	jalr	916(ra) # 4738 <printf>
    exit(1);
    33ac:	4505                	li	a0,1
    ...
    33bc:	e0850513          	addi	a0,a0,-504 # 61c0 <malloc+0x19ca>
    33c0:	00001097          	auipc	ra,0x1
    33c4:	378080e7          	jalr	888(ra) # 4738 <printf>
    exit(1);
    33c8:	4505                	li	a0,1
...
00000000000033d2 <iref>:
{
    ...
    33f0:	deca0a13          	addi	s4,s4,-532 # 61d8 <malloc+0x19e2>
    mkdir("");
    33f4:	00003497          	auipc	s1,0x3
    33f8:	9c448493          	addi	s1,s1,-1596 # 5db8 <malloc+0x15c2>
    link("README", "");
    33fc:	00003a97          	auipc	s5,0x3
    3400:	d4ca8a93          	addi	s5,s5,-692 # 6148 <malloc+0x1952>
    fd = open("xx", O_CREATE);
    3404:	00003997          	auipc	s3,0x3
    3408:	cc498993          	addi	s3,s3,-828 # 60c8 <malloc+0x18d2>
    340c:	a891                	j	3460 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    340e:	85da                	mv	a1,s6
    3410:	00003517          	auipc	a0,0x3
    3414:	dd050513          	addi	a0,a0,-560 # 61e0 <malloc+0x19ea>
    3418:	00001097          	auipc	ra,0x1
    341c:	320080e7          	jalr	800(ra) # 4738 <printf>
      exit(1);
    3420:	4505                	li	a0,1
    ...
    3430:	dcc50513          	addi	a0,a0,-564 # 61f8 <malloc+0x1a02>
    3434:	00001097          	auipc	ra,0x1
    3438:	304080e7          	jalr	772(ra) # 4738 <printf>
      exit(1);
    343c:	4505                	li	a0,1
  ...
  chdir("/");
    ...
    34c0:	73450513          	addi	a0,a0,1844 # 4bf0 <malloc+0x3fa>
...
00000000000034e0 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    34fc:	d1898993          	addi	s3,s3,-744 # 6210 <malloc+0x1a1a>
    3500:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    3538:	cec50513          	addi	a0,a0,-788 # 6220 <malloc+0x1a2a>
    353c:	00001097          	auipc	ra,0x1
    3540:	1fc080e7          	jalr	508(ra) # 4738 <printf>
      exit(1);
    3544:	4505                	li	a0,1
...
000000000000354e <sbrkbasic>:
{
  ...
  if(a != (char*)0xffffffffffffffffL){
    ...
    3578:	ccc50513          	addi	a0,a0,-820 # 6240 <malloc+0x1a4a>
    357c:	00001097          	auipc	ra,0x1
    3580:	1bc080e7          	jalr	444(ra) # 4738 <printf>
    exit(1);
    3584:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    35f2:	cba50513          	addi	a0,a0,-838 # 62a8 <malloc+0x1ab2>
    35f6:	00001097          	auipc	ra,0x1
    35fa:	142080e7          	jalr	322(ra) # 4738 <printf>
    exit(1);
    35fe:	4505                	li	a0,1
    ...
    3612:	c5a50513          	addi	a0,a0,-934 # 6268 <malloc+0x1a72>
    3616:	00001097          	auipc	ra,0x1
    361a:	122080e7          	jalr	290(ra) # 4738 <printf>
      exit(1);
    361e:	4505                	li	a0,1
    ...
    362e:	c5e50513          	addi	a0,a0,-930 # 6288 <malloc+0x1a92>
    3632:	00001097          	auipc	ra,0x1
    3636:	106080e7          	jalr	262(ra) # 4738 <printf>
    exit(1);
    363a:	4505                	li	a0,1
...
000000000000366a <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    36ae:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f3e37>
  a = sbrk(0);
    36b2:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    3712:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63f3e37>
  ...
  if(c != a){
    ...
    375a:	b7250513          	addi	a0,a0,-1166 # 62c8 <malloc+0x1ad2>
    375e:	00001097          	auipc	ra,0x1
    3762:	fda080e7          	jalr	-38(ra) # 4738 <printf>
    exit(1);
    3766:	4505                	li	a0,1
    ...
    3776:	b9e50513          	addi	a0,a0,-1122 # 6310 <malloc+0x1b1a>
    377a:	00001097          	auipc	ra,0x1
    377e:	fbe080e7          	jalr	-66(ra) # 4738 <printf>
    exit(1);
    3782:	4505                	li	a0,1
    ...
    3794:	ba050513          	addi	a0,a0,-1120 # 6330 <malloc+0x1b3a>
    3798:	00001097          	auipc	ra,0x1
    379c:	fa0080e7          	jalr	-96(ra) # 4738 <printf>
    exit(1);
    37a0:	4505                	li	a0,1
    ...
    37b2:	bc250513          	addi	a0,a0,-1086 # 6370 <malloc+0x1b7a>
    37b6:	00001097          	auipc	ra,0x1
    37ba:	f82080e7          	jalr	-126(ra) # 4738 <printf>
    exit(1);
    37be:	4505                	li	a0,1
    ...
    37ce:	bd650513          	addi	a0,a0,-1066 # 63a0 <malloc+0x1baa>
    37d2:	00001097          	auipc	ra,0x1
    37d6:	f66080e7          	jalr	-154(ra) # 4738 <printf>
    exit(1);
    37da:	4505                	li	a0,1
    ...
    37ec:	bf050513          	addi	a0,a0,-1040 # 63d8 <malloc+0x1be2>
    37f0:	00001097          	auipc	ra,0x1
    37f4:	f48080e7          	jalr	-184(ra) # 4738 <printf>
    exit(1);
    37f8:	4505                	li	a0,1
...
0000000000003802 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    3838:	df450513          	addi	a0,a0,-524 # 5628 <malloc+0xe32>
    383c:	00001097          	auipc	ra,0x1
    3840:	efc080e7          	jalr	-260(ra) # 4738 <printf>
    exit(1);
    3844:	4505                	li	a0,1
    ...
    386e:	e3e58593          	addi	a1,a1,-450 # 56a8 <malloc+0xeb2>
  ...
  if(xstatus != -1)
    ...
    392c:	ad850513          	addi	a0,a0,-1320 # 6400 <malloc+0x1c0a>
    3930:	00001097          	auipc	ra,0x1
    3934:	e08080e7          	jalr	-504(ra) # 4738 <printf>
    exit(1);
    3938:	4505                	li	a0,1
    ...
    3948:	3b450513          	addi	a0,a0,948 # 4cf8 <malloc+0x502>
    394c:	00001097          	auipc	ra,0x1
    3950:	dec080e7          	jalr	-532(ra) # 4738 <printf>
    exit(1);
    3954:	4505                	li	a0,1
    ...
    3992:	a9250513          	addi	a0,a0,-1390 # 6420 <malloc+0x1c2a>
    3996:	00001097          	auipc	ra,0x1
    399a:	da2080e7          	jalr	-606(ra) # 4738 <printf>
    exit(1);
    399e:	4505                	li	a0,1
...
00000000000039b2 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    39d6:	a7e50513          	addi	a0,a0,-1410 # 6450 <malloc+0x1c5a>
    39da:	00001097          	auipc	ra,0x1
    39de:	a0e080e7          	jalr	-1522(ra) # 43e8 <open>
    39e2:	84aa                	mv	s1,a0
  unlink("sbrk");
    39e4:	00003517          	auipc	a0,0x3
    39e8:	a6c50513          	addi	a0,a0,-1428 # 6450 <malloc+0x1c5a>
  ...
  if(pipe((int *) a) != 0){
    ...
    3a3c:	a2050513          	addi	a0,a0,-1504 # 6458 <malloc+0x1c62>
    3a40:	00001097          	auipc	ra,0x1
    3a44:	cf8080e7          	jalr	-776(ra) # 4738 <printf>
    exit(1);
    3a48:	4505                	li	a0,1
    ...
    3a58:	a1c50513          	addi	a0,a0,-1508 # 6470 <malloc+0x1c7a>
    3a5c:	00001097          	auipc	ra,0x1
    3a60:	cdc080e7          	jalr	-804(ra) # 4738 <printf>
    exit(1);
    3a64:	4505                	li	a0,1
    ...
    3a74:	bb850513          	addi	a0,a0,-1096 # 5628 <malloc+0xe32>
    3a78:	00001097          	auipc	ra,0x1
    3a7c:	cc0080e7          	jalr	-832(ra) # 4738 <printf>
    exit(1);
    3a80:	4505                	li	a0,1
...
0000000000003a8a <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    3a9e:	9ee50513          	addi	a0,a0,-1554 # 6488 <malloc+0x1c92>
  ...
  close(fd);
    ...
    3ae6:	9e650513          	addi	a0,a0,-1562 # 54c8 <malloc+0xcd2>
    3aea:	00001097          	auipc	ra,0x1
    3aee:	c4e080e7          	jalr	-946(ra) # 4738 <printf>
    exit(1);
    3af2:	4505                	li	a0,1
...
0000000000003afc <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    3b34:	ac850513          	addi	a0,a0,-1336 # 55f8 <malloc+0xe02>
    3b38:	00001097          	auipc	ra,0x1
    3b3c:	c00080e7          	jalr	-1024(ra) # 4738 <printf>
    exit(1);
    3b40:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    3b8a:	a7250513          	addi	a0,a0,-1422 # 55f8 <malloc+0xe02>
    3b8e:	00001097          	auipc	ra,0x1
    3b92:	baa080e7          	jalr	-1110(ra) # 4738 <printf>
    exit(1);
    3b96:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    3bea:	a1250513          	addi	a0,a0,-1518 # 55f8 <malloc+0xe02>
    3bee:	00001097          	auipc	ra,0x1
    3bf2:	b4a080e7          	jalr	-1206(ra) # 4738 <printf>
    exit(1);
    3bf6:	4505                	li	a0,1
...
0000000000003c14 <dirtest>:
{
  ...
  printf("mkdir test\n");
    ...
    3c24:	87050513          	addi	a0,a0,-1936 # 6490 <malloc+0x1c9a>
    3c28:	00001097          	auipc	ra,0x1
    3c2c:	b10080e7          	jalr	-1264(ra) # 4738 <printf>
  if(mkdir("dir0") < 0){
    3c30:	00003517          	auipc	a0,0x3
    3c34:	87050513          	addi	a0,a0,-1936 # 64a0 <malloc+0x1caa>
  ...
  if(chdir("dir0") < 0){
    ...
    3c48:	85c50513          	addi	a0,a0,-1956 # 64a0 <malloc+0x1caa>
  ...
  if(chdir("..") < 0){
    ...
    3c5c:	01050513          	addi	a0,a0,16 # 4c68 <malloc+0x472>
  ...
  if(unlink("dir0") < 0){
    ...
    3c70:	83450513          	addi	a0,a0,-1996 # 64a0 <malloc+0x1caa>
  ...
  printf("%s: mkdir test ok\n");
    ...
    3c84:	87050513          	addi	a0,a0,-1936 # 64f0 <malloc+0x1cfa>
    3c88:	00001097          	auipc	ra,0x1
    3c8c:	ab0080e7          	jalr	-1360(ra) # 4738 <printf>
}
    ...
    3ca0:	eec50513          	addi	a0,a0,-276 # 4b88 <malloc+0x392>
    3ca4:	00001097          	auipc	ra,0x1
    3ca8:	a94080e7          	jalr	-1388(ra) # 4738 <printf>
    exit(1);
    3cac:	4505                	li	a0,1
    ...
    3cbc:	7f050513          	addi	a0,a0,2032 # 64a8 <malloc+0x1cb2>
    3cc0:	00001097          	auipc	ra,0x1
    3cc4:	a78080e7          	jalr	-1416(ra) # 4738 <printf>
    exit(1);
    3cc8:	4505                	li	a0,1
    ...
    3cd8:	7ec50513          	addi	a0,a0,2028 # 64c0 <malloc+0x1cca>
    3cdc:	00001097          	auipc	ra,0x1
    3ce0:	a5c080e7          	jalr	-1444(ra) # 4738 <printf>
    exit(1);
    3ce4:	4505                	li	a0,1
    ...
    3cf4:	7e850513          	addi	a0,a0,2024 # 64d8 <malloc+0x1ce2>
    3cf8:	00001097          	auipc	ra,0x1
    3cfc:	a40080e7          	jalr	-1472(ra) # 4738 <printf>
    exit(1);
    3d00:	4505                	li	a0,1
...
0000000000003d0a <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    3d2c:	7e050513          	addi	a0,a0,2016 # 6508 <malloc+0x1d12>
    3d30:	00001097          	auipc	ra,0x1
    3d34:	a08080e7          	jalr	-1528(ra) # 4738 <printf>
  for(nfiles = 0; ; nfiles++){
    3d38:	4481                	li	s1,0
    name[0] = 'f';
    ...
    3d4c:	7d0c8c93          	addi	s9,s9,2000 # 6518 <malloc+0x1d22>
    int total = 0;
    3d50:	4d81                	li	s11,0
      int cc = write(fd, buf, BSIZE);
    3d52:	00005a17          	auipc	s4,0x5
    3d56:	466a0a13          	addi	s4,s4,1126 # 91b8 <buf>
    name[0] = 'f';
    ...
    3da4:	998080e7          	jalr	-1640(ra) # 4738 <printf>
    ...
    3dc6:	76650513          	addi	a0,a0,1894 # 6528 <malloc+0x1d32>
    3dca:	00001097          	auipc	ra,0x1
    3dce:	96e080e7          	jalr	-1682(ra) # 4738 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    3e3c:	72050513          	addi	a0,a0,1824 # 6558 <malloc+0x1d62>
    3e40:	00001097          	auipc	ra,0x1
    3e44:	8f8080e7          	jalr	-1800(ra) # 4738 <printf>
}
    ...
    3e8c:	6b850513          	addi	a0,a0,1720 # 6540 <malloc+0x1d4a>
    3e90:	00001097          	auipc	ra,0x1
    3e94:	8a8080e7          	jalr	-1880(ra) # 4738 <printf>
    close(fd);
    3e98:	854a                	mv	a0,s2
...
0000000000003eaa <rand>:
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    3eb4:	ae070713          	addi	a4,a4,-1312 # 6990 <randstate>
    3eb8:	6308                	ld	a0,0(a4)
    3eba:	001967b7          	lui	a5,0x196
    3ebe:	60d78793          	addi	a5,a5,1549 # 19660d <__BSS_END__+0x18a445>
    3ec2:	02f50533          	mul	a0,a0,a5
    3ec6:	3c6ef7b7          	lui	a5,0x3c6ef
    3eca:	35f78793          	addi	a5,a5,863 # 3c6ef35f <__BSS_END__+0x3c6e3197>
...
0000000000003eda <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    3f4e:	62650513          	addi	a0,a0,1574 # 6570 <malloc+0x1d7a>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    3f66:	74658593          	addi	a1,a1,1862 # 56a8 <malloc+0xeb2>
    ...
    3f7c:	61850513          	addi	a0,a0,1560 # 6590 <malloc+0x1d9a>
    3f80:	00000097          	auipc	ra,0x0
    3f84:	7b8080e7          	jalr	1976(ra) # 4738 <printf>
    exit(1);
    3f88:	4505                	li	a0,1
    ...
    3f96:	5e650513          	addi	a0,a0,1510 # 6578 <malloc+0x1d82>
    3f9a:	00000097          	auipc	ra,0x0
    3f9e:	79e080e7          	jalr	1950(ra) # 4738 <printf>
      exit(1);
    3fa2:	4505                	li	a0,1
    ...
    3fb0:	5cc50513          	addi	a0,a0,1484 # 6578 <malloc+0x1d82>
    3fb4:	00000097          	auipc	ra,0x0
    3fb8:	784080e7          	jalr	1924(ra) # 4738 <printf>
    exit(1);
    3fbc:	4505                	li	a0,1
  ...
  unlink("junk");
    ...
    3fd4:	5a050513          	addi	a0,a0,1440 # 6570 <malloc+0x1d7a>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    3ffe:	5a650513          	addi	a0,a0,1446 # 65a0 <malloc+0x1daa>
    4002:	00000097          	auipc	ra,0x0
    4006:	736080e7          	jalr	1846(ra) # 4738 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    4030:	59c50513          	addi	a0,a0,1436 # 65c8 <malloc+0x1dd2>
    4034:	00000097          	auipc	ra,0x0
    4038:	704080e7          	jalr	1796(ra) # 4738 <printf>
    else
      printf("OK\n", s);
    return xstatus == 0;
    ...
    4054:	56050513          	addi	a0,a0,1376 # 65b0 <malloc+0x1dba>
    4058:	00000097          	auipc	ra,0x0
    405c:	6e0080e7          	jalr	1760(ra) # 4738 <printf>
    exit(1);
    4060:	4505                	li	a0,1
    ...
    407e:	55650513          	addi	a0,a0,1366 # 65d0 <malloc+0x1dda>
    4082:	00000097          	auipc	ra,0x0
    4086:	6b6080e7          	jalr	1718(ra) # 4738 <printf>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    40ba:	5c278793          	addi	a5,a5,1474 # 6678 <malloc+0x1e82>
    40be:	ce040713          	addi	a4,s0,-800
    40c2:	00003817          	auipc	a6,0x3
    40c6:	89680813          	addi	a6,a6,-1898 # 6958 <malloc+0x2162>
  ...
  printf("usertests starting\n");
    ...
    40f2:	4ea50513          	addi	a0,a0,1258 # 65d8 <malloc+0x1de2>
    40f6:	00000097          	auipc	ra,0x0
    40fa:	642080e7          	jalr	1602(ra) # 4738 <printf>

  if(open("usertests.ran", 0) >= 0){
    40fe:	4581                	li	a1,0
    4100:	00002517          	auipc	a0,0x2
    4104:	4f050513          	addi	a0,a0,1264 # 65f0 <malloc+0x1dfa>
    ...
    4118:	4ec50513          	addi	a0,a0,1260 # 6600 <malloc+0x1e0a>
    411c:	00000097          	auipc	ra,0x0
    4120:	61c080e7          	jalr	1564(ra) # 4738 <printf>
    exit(1);
    4124:	4505                	li	a0,1
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    4136:	4be50513          	addi	a0,a0,1214 # 65f0 <malloc+0x1dfa>
  ...
  if(!fail)
    ...
    418a:	4da50513          	addi	a0,a0,1242 # 6660 <malloc+0x1e6a>
    418e:	00000097          	auipc	ra,0x0
    4192:	5aa080e7          	jalr	1450(ra) # 4738 <printf>
    4196:	a809                	j	41a8 <main+0x11c>
    printf("ALL TESTS PASSED\n");
    4198:	00002517          	auipc	a0,0x2
    419c:	4b050513          	addi	a0,a0,1200 # 6648 <malloc+0x1e52>
    41a0:	00000097          	auipc	ra,0x0
    41a4:	598080e7          	jalr	1432(ra) # 4738 <printf>
  exit(1);   // not reached.
    41a8:	4505                	li	a0,1
...
putc(int fd, char c)
{
    4460:	1101                	addi	sp,sp,-32
    4462:	ec06                	sd	ra,24(sp)
    4464:	e822                	sd	s0,16(sp)
    4466:	1000                	addi	s0,sp,32
    4468:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    446c:	4605                	li	a2,1
    446e:	fef40593          	addi	a1,s0,-17
    4472:	00000097          	auipc	ra,0x0
    4476:	f56080e7          	jalr	-170(ra) # 43c8 <write>
}
    447a:	60e2                	ld	ra,24(sp)
    447c:	6442                	ld	s0,16(sp)
    447e:	6105                	addi	sp,sp,32
    4480:	8082                	ret

0000000000004482 <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
    4482:	7139                	addi	sp,sp,-64
    4484:	fc06                	sd	ra,56(sp)
    4486:	f822                	sd	s0,48(sp)
    4488:	f426                	sd	s1,40(sp)
    448a:	f04a                	sd	s2,32(sp)
    448c:	ec4e                	sd	s3,24(sp)
    448e:	0080                	addi	s0,sp,64
    4490:	84aa                	mv	s1,a0
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    4492:	c299                	beqz	a3,4498 <printint+0x16>
    4494:	0805c863          	bltz	a1,4524 <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    4498:	2581                	sext.w	a1,a1
  neg = 0;
    449a:	4881                	li	a7,0
    449c:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    44a2:	2601                	sext.w	a2,a2
    44a4:	00002517          	auipc	a0,0x2
    44a8:	4cc50513          	addi	a0,a0,1228 # 6970 <digits>
    44ac:	883a                	mv	a6,a4
    44ae:	2705                	addiw	a4,a4,1
    44b0:	02c5f7bb          	remuw	a5,a1,a2
    44b4:	1782                	slli	a5,a5,0x20
    44b6:	9381                	srli	a5,a5,0x20
    44b8:	97aa                	add	a5,a5,a0
    44ba:	0007c783          	lbu	a5,0(a5)
    44be:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    44c2:	0005879b          	sext.w	a5,a1
    44c6:	02c5d5bb          	divuw	a1,a1,a2
    44ca:	0685                	addi	a3,a3,1
    44cc:	fec7f0e3          	bgeu	a5,a2,44ac <printint+0x2a>
  if(neg)
    44d0:	00088b63          	beqz	a7,44e6 <printint+0x64>
    buf[i++] = '-';
    44d4:	fd040793          	addi	a5,s0,-48
    44d8:	973e                	add	a4,a4,a5
    44da:	02d00793          	li	a5,45
    44de:	fef70823          	sb	a5,-16(a4)
    44e2:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    44e6:	02e05863          	blez	a4,4516 <printint+0x94>
    44ea:	fc040793          	addi	a5,s0,-64
    44ee:	00e78933          	add	s2,a5,a4
    44f2:	fff78993          	addi	s3,a5,-1
    44f6:	99ba                	add	s3,s3,a4
    44f8:	377d                	addiw	a4,a4,-1
    44fa:	1702                	slli	a4,a4,0x20
    44fc:	9301                	srli	a4,a4,0x20
    44fe:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    4502:	fff94583          	lbu	a1,-1(s2)
    4506:	8526                	mv	a0,s1
    4508:	00000097          	auipc	ra,0x0
    450c:	f58080e7          	jalr	-168(ra) # 4460 <putc>
  while(--i >= 0)
    4510:	197d                	addi	s2,s2,-1
    4512:	ff3918e3          	bne	s2,s3,4502 <printint+0x80>
}
    4516:	70e2                	ld	ra,56(sp)
    4518:	7442                	ld	s0,48(sp)
    451a:	74a2                	ld	s1,40(sp)
    451c:	7902                	ld	s2,32(sp)
    451e:	69e2                	ld	s3,24(sp)
    4520:	6121                	addi	sp,sp,64
    4522:	8082                	ret
    x = -xx;
    4524:	40b005bb          	negw	a1,a1
    neg = 1;
    4528:	4885                	li	a7,1
    x = -xx;
    452a:	bf8d                	j	449c <printint+0x1a>

000000000000452c <vprintf>:
}
...
{
    452c:	7119                	addi	sp,sp,-128
    452e:	fc86                	sd	ra,120(sp)
    4530:	f8a2                	sd	s0,112(sp)
    4532:	f4a6                	sd	s1,104(sp)
    4534:	f0ca                	sd	s2,96(sp)
    4536:	ecce                	sd	s3,88(sp)
    4538:	e8d2                	sd	s4,80(sp)
    453a:	e4d6                	sd	s5,72(sp)
    453c:	e0da                	sd	s6,64(sp)
    453e:	fc5e                	sd	s7,56(sp)
    4540:	f862                	sd	s8,48(sp)
    4542:	f466                	sd	s9,40(sp)
    4544:	f06a                	sd	s10,32(sp)
    4546:	ec6e                	sd	s11,24(sp)
  ...
  state = 0;
  for(i = 0; fmt[i]; i++){
    454a:	0005c903          	lbu	s2,0(a1)
    454e:	18090f63          	beqz	s2,46ec <vprintf+0x1c0>
    4552:	8aaa                	mv	s5,a0
    4554:	8b32                	mv	s6,a2
    4556:	00158493          	addi	s1,a1,1
  state = 0;
    455a:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    455c:	02500a13          	li	s4,37
      if(c == 'd'){
    4560:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
    4564:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
    4568:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
    456c:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    4570:	00002b97          	auipc	s7,0x2
    4574:	400b8b93          	addi	s7,s7,1024 # 6970 <digits>
    4578:	a839                	j	4596 <vprintf+0x6a>
        putc(fd, c);
    457a:	85ca                	mv	a1,s2
    457c:	8556                	mv	a0,s5
    457e:	00000097          	auipc	ra,0x0
    4582:	ee2080e7          	jalr	-286(ra) # 4460 <putc>
    4586:	a019                	j	458c <vprintf+0x60>
    } else if(state == '%'){
    4588:	01498f63          	beq	s3,s4,45a6 <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
    458c:	0485                	addi	s1,s1,1
    458e:	fff4c903          	lbu	s2,-1(s1)
    4592:	14090d63          	beqz	s2,46ec <vprintf+0x1c0>
    c = fmt[i] & 0xff;
    4596:	0009079b          	sext.w	a5,s2
    if(state == 0){
    459a:	fe0997e3          	bnez	s3,4588 <vprintf+0x5c>
      if(c == '%'){
    459e:	fd479ee3          	bne	a5,s4,457a <vprintf+0x4e>
        state = '%';
    45a2:	89be                	mv	s3,a5
    45a4:	b7e5                	j	458c <vprintf+0x60>
      if(c == 'd'){
    45a6:	05878063          	beq	a5,s8,45e6 <vprintf+0xba>
      } else if(c == 'l') {
    45aa:	05978c63          	beq	a5,s9,4602 <vprintf+0xd6>
      } else if(c == 'x') {
    45ae:	07a78863          	beq	a5,s10,461e <vprintf+0xf2>
      } else if(c == 'p') {
    45b2:	09b78463          	beq	a5,s11,463a <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
    45b6:	07300713          	li	a4,115
    45ba:	0ce78663          	beq	a5,a4,4686 <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    45be:	06300713          	li	a4,99
    45c2:	0ee78e63          	beq	a5,a4,46be <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
    45c6:	11478863          	beq	a5,s4,46d6 <vprintf+0x1aa>
        putc(fd, c);
      } else {
    ...
    45d2:	e92080e7          	jalr	-366(ra) # 4460 <putc>
        putc(fd, c);
    45d6:	85ca                	mv	a1,s2
    45d8:	8556                	mv	a0,s5
    45da:	00000097          	auipc	ra,0x0
    45de:	e86080e7          	jalr	-378(ra) # 4460 <putc>
      }
      state = 0;
    45e2:	4981                	li	s3,0
    45e4:	b765                	j	458c <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
    45e6:	008b0913          	addi	s2,s6,8
    45ea:	4685                	li	a3,1
    45ec:	4629                	li	a2,10
    45ee:	000b2583          	lw	a1,0(s6)
    45f2:	8556                	mv	a0,s5
    45f4:	00000097          	auipc	ra,0x0
    45f8:	e8e080e7          	jalr	-370(ra) # 4482 <printint>
    45fc:	8b4a                	mv	s6,s2
      state = 0;
    45fe:	4981                	li	s3,0
    4600:	b771                	j	458c <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    4602:	008b0913          	addi	s2,s6,8
    4606:	4681                	li	a3,0
    4608:	4629                	li	a2,10
    460a:	000b2583          	lw	a1,0(s6)
    460e:	8556                	mv	a0,s5
    4610:	00000097          	auipc	ra,0x0
    4614:	e72080e7          	jalr	-398(ra) # 4482 <printint>
    4618:	8b4a                	mv	s6,s2
      state = 0;
    461a:	4981                	li	s3,0
    461c:	bf85                	j	458c <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
    461e:	008b0913          	addi	s2,s6,8
    4622:	4681                	li	a3,0
    4624:	4641                	li	a2,16
    4626:	000b2583          	lw	a1,0(s6)
    462a:	8556                	mv	a0,s5
    462c:	00000097          	auipc	ra,0x0
    4630:	e56080e7          	jalr	-426(ra) # 4482 <printint>
    4634:	8b4a                	mv	s6,s2
      state = 0;
    4636:	4981                	li	s3,0
    4638:	bf91                	j	458c <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    463a:	008b0793          	addi	a5,s6,8
    463e:	f8f43423          	sd	a5,-120(s0)
    4642:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    4646:	03000593          	li	a1,48
    464a:	8556                	mv	a0,s5
    464c:	00000097          	auipc	ra,0x0
    4650:	e14080e7          	jalr	-492(ra) # 4460 <putc>
  putc(fd, 'x');
    4654:	85ea                	mv	a1,s10
    4656:	8556                	mv	a0,s5
    4658:	00000097          	auipc	ra,0x0
    465c:	e08080e7          	jalr	-504(ra) # 4460 <putc>
    4660:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    4662:	03c9d793          	srli	a5,s3,0x3c
    4666:	97de                	add	a5,a5,s7
    4668:	0007c583          	lbu	a1,0(a5)
    466c:	8556                	mv	a0,s5
    466e:	00000097          	auipc	ra,0x0
    4672:	df2080e7          	jalr	-526(ra) # 4460 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    4676:	0992                	slli	s3,s3,0x4
    4678:	397d                	addiw	s2,s2,-1
    467a:	fe0914e3          	bnez	s2,4662 <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    467e:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    4682:	4981                	li	s3,0
    4684:	b721                	j	458c <vprintf+0x60>
        s = va_arg(ap, char*);
    4686:	008b0993          	addi	s3,s6,8
    468a:	000b3903          	ld	s2,0(s6)
        if(s == 0)
    468e:	02090163          	beqz	s2,46b0 <vprintf+0x184>
        while(*s != 0){
    4692:	00094583          	lbu	a1,0(s2)
    4696:	c9a1                	beqz	a1,46e6 <vprintf+0x1ba>
          putc(fd, *s);
    4698:	8556                	mv	a0,s5
    469a:	00000097          	auipc	ra,0x0
    469e:	dc6080e7          	jalr	-570(ra) # 4460 <putc>
          s++;
    46a2:	0905                	addi	s2,s2,1
        while(*s != 0){
    46a4:	00094583          	lbu	a1,0(s2)
    46a8:	f9e5                	bnez	a1,4698 <vprintf+0x16c>
        s = va_arg(ap, char*);
    46aa:	8b4e                	mv	s6,s3
      state = 0;
    46ac:	4981                	li	s3,0
    46ae:	bdf9                	j	458c <vprintf+0x60>
          s = "(null)";
    46b0:	00002917          	auipc	s2,0x2
    46b4:	2b890913          	addi	s2,s2,696 # 6968 <malloc+0x2172>
        while(*s != 0){
    46b8:	02800593          	li	a1,40
    46bc:	bff1                	j	4698 <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
    46be:	008b0913          	addi	s2,s6,8
    46c2:	000b4583          	lbu	a1,0(s6)
    46c6:	8556                	mv	a0,s5
    46c8:	00000097          	auipc	ra,0x0
    46cc:	d98080e7          	jalr	-616(ra) # 4460 <putc>
    46d0:	8b4a                	mv	s6,s2
      state = 0;
    46d2:	4981                	li	s3,0
    46d4:	bd65                	j	458c <vprintf+0x60>
        putc(fd, c);
    46d6:	85d2                	mv	a1,s4
    46d8:	8556                	mv	a0,s5
    46da:	00000097          	auipc	ra,0x0
    46de:	d86080e7          	jalr	-634(ra) # 4460 <putc>
      state = 0;
    46e2:	4981                	li	s3,0
    46e4:	b565                	j	458c <vprintf+0x60>
        s = va_arg(ap, char*);
    46e6:	8b4e                	mv	s6,s3
      state = 0;
    46e8:	4981                	li	s3,0
    46ea:	b54d                	j	458c <vprintf+0x60>
    }
  }
}
    46ec:	70e6                	ld	ra,120(sp)
    46ee:	7446                	ld	s0,112(sp)
    46f0:	74a6                	ld	s1,104(sp)
    46f2:	7906                	ld	s2,96(sp)
    46f4:	69e6                	ld	s3,88(sp)
    46f6:	6a46                	ld	s4,80(sp)
    46f8:	6aa6                	ld	s5,72(sp)
    46fa:	6b06                	ld	s6,64(sp)
    46fc:	7be2                	ld	s7,56(sp)
    46fe:	7c42                	ld	s8,48(sp)
    4700:	7ca2                	ld	s9,40(sp)
    4702:	7d02                	ld	s10,32(sp)
    4704:	6de2                	ld	s11,24(sp)
    4706:	6109                	addi	sp,sp,128
    4708:	8082                	ret

000000000000470a <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    470a:	715d                	addi	sp,sp,-80
    470c:	ec06                	sd	ra,24(sp)
    470e:	e822                	sd	s0,16(sp)
    4710:	1000                	addi	s0,sp,32
    4712:	e010                	sd	a2,0(s0)
    4714:	e414                	sd	a3,8(s0)
    4716:	e818                	sd	a4,16(s0)
    4718:	ec1c                	sd	a5,24(s0)
    471a:	03043023          	sd	a6,32(s0)
    471e:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    4722:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    4726:	8622                	mv	a2,s0
    4728:	00000097          	auipc	ra,0x0
    472c:	e04080e7          	jalr	-508(ra) # 452c <vprintf>
}
    4730:	60e2                	ld	ra,24(sp)
    4732:	6442                	ld	s0,16(sp)
    4734:	6161                	addi	sp,sp,80
    4736:	8082                	ret

0000000000004738 <printf>:

void
printf(const char *fmt, ...)
{
    4738:	711d                	addi	sp,sp,-96
    473a:	ec06                	sd	ra,24(sp)
    473c:	e822                	sd	s0,16(sp)
    473e:	1000                	addi	s0,sp,32
    4740:	e40c                	sd	a1,8(s0)
    4742:	e810                	sd	a2,16(s0)
    4744:	ec14                	sd	a3,24(s0)
    4746:	f018                	sd	a4,32(s0)
    4748:	f41c                	sd	a5,40(s0)
    474a:	03043823          	sd	a6,48(s0)
    474e:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    4752:	00840613          	addi	a2,s0,8
    4756:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    475a:	85aa                	mv	a1,a0
    475c:	4505                	li	a0,1
    475e:	00000097          	auipc	ra,0x0
    4762:	dce080e7          	jalr	-562(ra) # 452c <vprintf>
}
    4766:	60e2                	ld	ra,24(sp)
    4768:	6442                	ld	s0,16(sp)
    476a:	6125                	addi	sp,sp,96
    476c:	8082                	ret

000000000000476e <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    ...
    4770:	e422                	sd	s0,8(sp)
    4772:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    4774:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4778:	00002797          	auipc	a5,0x2
    477c:	2287b783          	ld	a5,552(a5) # 69a0 <freep>
    4780:	a805                	j	47b0 <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    4782:	4618                	lw	a4,8(a2)
    4784:	9db9                	addw	a1,a1,a4
    4786:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    478a:	6398                	ld	a4,0(a5)
    478c:	6318                	ld	a4,0(a4)
    478e:	fee53823          	sd	a4,-16(a0)
    4792:	a091                	j	47d6 <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    4794:	ff852703          	lw	a4,-8(a0)
    4798:	9e39                	addw	a2,a2,a4
    479a:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    479c:	ff053703          	ld	a4,-16(a0)
    47a0:	e398                	sd	a4,0(a5)
    47a2:	a099                	j	47e8 <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    47a4:	6398                	ld	a4,0(a5)
    47a6:	00e7e463          	bltu	a5,a4,47ae <free+0x40>
    47aa:	00e6ea63          	bltu	a3,a4,47be <free+0x50>
{
    47ae:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    47b0:	fed7fae3          	bgeu	a5,a3,47a4 <free+0x36>
    47b4:	6398                	ld	a4,0(a5)
    47b6:	00e6e463          	bltu	a3,a4,47be <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    47ba:	fee7eae3          	bltu	a5,a4,47ae <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    47be:	ff852583          	lw	a1,-8(a0)
    47c2:	6390                	ld	a2,0(a5)
    47c4:	02059713          	slli	a4,a1,0x20
    47c8:	9301                	srli	a4,a4,0x20
    47ca:	0712                	slli	a4,a4,0x4
    47cc:	9736                	add	a4,a4,a3
    47ce:	fae60ae3          	beq	a2,a4,4782 <free+0x14>
    bp->s.ptr = p->s.ptr;
    47d2:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    47d6:	4790                	lw	a2,8(a5)
    47d8:	02061713          	slli	a4,a2,0x20
    47dc:	9301                	srli	a4,a4,0x20
    47de:	0712                	slli	a4,a4,0x4
    47e0:	973e                	add	a4,a4,a5
    47e2:	fae689e3          	beq	a3,a4,4794 <free+0x26>
  } else
    p->s.ptr = bp;
    47e6:	e394                	sd	a3,0(a5)
  freep = p;
    47e8:	00002717          	auipc	a4,0x2
    47ec:	1af73c23          	sd	a5,440(a4) # 69a0 <freep>
}
    47f0:	6422                	ld	s0,8(sp)
    47f2:	0141                	addi	sp,sp,16
    47f4:	8082                	ret

00000000000047f6 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    47f6:	7139                	addi	sp,sp,-64
    47f8:	fc06                	sd	ra,56(sp)
    47fa:	f822                	sd	s0,48(sp)
    47fc:	f426                	sd	s1,40(sp)
    47fe:	f04a                	sd	s2,32(sp)
    4800:	ec4e                	sd	s3,24(sp)
    4802:	e852                	sd	s4,16(sp)
    4804:	e456                	sd	s5,8(sp)
    4806:	e05a                	sd	s6,0(sp)
    4808:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    480a:	02051493          	slli	s1,a0,0x20
    480e:	9081                	srli	s1,s1,0x20
    4810:	04bd                	addi	s1,s1,15
    4812:	8091                	srli	s1,s1,0x4
    4814:	0014899b          	addiw	s3,s1,1
    4818:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    481a:	00002517          	auipc	a0,0x2
    481e:	18653503          	ld	a0,390(a0) # 69a0 <freep>
    4822:	c515                	beqz	a0,484e <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    4824:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    4826:	4798                	lw	a4,8(a5)
    4828:	02977f63          	bgeu	a4,s1,4866 <malloc+0x70>
    482c:	8a4e                	mv	s4,s3
    482e:	0009871b          	sext.w	a4,s3
    4832:	6685                	lui	a3,0x1
    4834:	00d77363          	bgeu	a4,a3,483a <malloc+0x44>
    4838:	6a05                	lui	s4,0x1
    483a:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    483e:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    4842:	00002917          	auipc	s2,0x2
    4846:	15e90913          	addi	s2,s2,350 # 69a0 <freep>
  if(p == (char*)-1)
    484a:	5afd                	li	s5,-1
    484c:	a88d                	j	48be <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    484e:	00008797          	auipc	a5,0x8
    4852:	96a78793          	addi	a5,a5,-1686 # c1b8 <base>
    4856:	00002717          	auipc	a4,0x2
    485a:	14f73523          	sd	a5,330(a4) # 69a0 <freep>
    485e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    4860:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    4864:	b7e1                	j	482c <malloc+0x36>
      if(p->s.size == nunits)
    4866:	02e48b63          	beq	s1,a4,489c <malloc+0xa6>
        p->s.size -= nunits;
    486a:	4137073b          	subw	a4,a4,s3
    486e:	c798                	sw	a4,8(a5)
        p += p->s.size;
    4870:	1702                	slli	a4,a4,0x20
    4872:	9301                	srli	a4,a4,0x20
    4874:	0712                	slli	a4,a4,0x4
    4876:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    4878:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    487c:	00002717          	auipc	a4,0x2
    4880:	12a73223          	sd	a0,292(a4) # 69a0 <freep>
      return (void*)(p + 1);
    4884:	01078513          	addi	a0,a5,16
      if((p = morecore(nunits)) == 0)
        return 0;
  }
}
    4888:	70e2                	ld	ra,56(sp)
    488a:	7442                	ld	s0,48(sp)
    488c:	74a2                	ld	s1,40(sp)
    488e:	7902                	ld	s2,32(sp)
    4890:	69e2                	ld	s3,24(sp)
    4892:	6a42                	ld	s4,16(sp)
    4894:	6aa2                	ld	s5,8(sp)
    4896:	6b02                	ld	s6,0(sp)
    4898:	6121                	addi	sp,sp,64
    489a:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    489c:	6398                	ld	a4,0(a5)
    489e:	e118                	sd	a4,0(a0)
    48a0:	bff1                	j	487c <malloc+0x86>
  hp->s.size = nu;
    48a2:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    48a6:	0541                	addi	a0,a0,16
    48a8:	00000097          	auipc	ra,0x0
    48ac:	ec6080e7          	jalr	-314(ra) # 476e <free>
  return freep;
    48b0:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    48b4:	d971                	beqz	a0,4888 <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    48b6:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    48b8:	4798                	lw	a4,8(a5)
    48ba:	fa9776e3          	bgeu	a4,s1,4866 <malloc+0x70>
    if(p == freep)
    48be:	00093703          	ld	a4,0(s2)
    48c2:	853e                	mv	a0,a5
    48c4:	fef719e3          	bne	a4,a5,48b6 <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
    48c8:	8552                	mv	a0,s4
    48ca:	00000097          	auipc	ra,0x0
    48ce:	b66080e7          	jalr	-1178(ra) # 4430 <sbrk>
  if(p == (char*)-1)
    48d2:	fd5518e3          	bne	a0,s5,48a2 <malloc+0xac>
        return 0;
    48d6:	4501                	li	a0,0
    48d8:	bf45                	j	4888 <malloc+0x92>
